  ...
  },
  {
    ...
    items: [
      ...
      { href: '/einstellungen', label: 'Einstellungen', icon: ICON_PATHS.settings },
      {
        href: '/hilfe',
        label: 'Hilfe & Support',
        icon: (<><circle cx="12" cy="12" r="9" /><path d="M9.3 9a2.8 2.8 0 1 1 3.9 2.6c-.8.35-1.2 1-1.2 1.9v.2M12 17h.01" /></>),
      },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: (<path d="M21 11.5a8.4 8.4 0 0 1-9 8.4 9 9 0 0 1-3.8-.8L3 20l1-4.9a8.4 8.4 0 1 1 17-3.6z" />),
        rollen: PLATTFORM_ROLLEN,
      },
