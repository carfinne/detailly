...
export const pt: Partial<Dict> = {
  ...
  'fahrzeugtyp.label': "Tipo de veículo",
  'fahrzeugtyp.hint': "Escolha a forma da carroçaria para o modelo 3D",
  'fahrzeugtyp.limousine': "Sedã",
  'fahrzeugtyp.kombi': "Carrinha/SW",
  'fahrzeugtyp.suv': "SUV/todo-o-terreno",
  'fahrzeugtyp.coupe': "Cupé",
  'fahrzeugtyp.kompakt': "Compacto/citadino",
  'fahrzeugtyp.transporter': "Furgão/Van",
  'fahrzeugtyp.pickup': "Pickup",
  'fahrzeugtyp.error.save': "Não foi possível guardar o tipo de veículo.",
  // ---- Gemeinsame UI-Texte -------------------------------------------------
  'common.save': "Guardar",
  ...
  'landing.hero.headlinePre': "Veículo dentro, dano documentado, cliente assina — em ",
  'landing.hero.headlineEm': "quatro minutos",
  'landing.hero.headlinePost': ".",
  'landing.hero.title1': "O seu ofício é a precisão.",
  'landing.hero.title2': "Agora o seu software também.",
  'landing.hero.sub': "O Detailly é o software de oficina para detailing, envelopamento e PPF: receção, quadro de planeamento, faturação e livro de caixa num só sistema — comprovável em vez de de cor.",
