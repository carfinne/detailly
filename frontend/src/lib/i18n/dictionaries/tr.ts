...
export const tr: Partial<Dict> = {
  ...
  'landing.hero.headlinePre': "Araca ",
  'landing.hero.headlineEm': "daha çok zaman",
  'landing.hero.headlinePost': ". Ofiste daha az zaman.",
  'landing.hero.title1': "Sizin işiniz hassasiyet.",
  'landing.hero.title2': "Artık yazılımınız da öyle.",
  'landing.hero.sub': "Aracın kabulü, 3D hasar tespiti ve imza dört dakikada — iş emri, fatura ve ödeme hatırlatması hemen birlikte oluşur.",
  ...
  'landing.datenblatt.dellen.label': "Göçük hesaplama",
  'landing.datenblatt.dellen.fact': "Smart Repair / PDR · anlık fiyat",
  'landing.datenblatt.buchhaltung.label': "Muhasebe",
  'landing.datenblatt.buchhaltung.fact': "DATEV · sevDesk · CSV",
  'landing.datenblatt.shop.label': "Mağaza ve pazar yeri",
  'landing.datenblatt.shop.fact': "B2B alım · film kütüphanesi",
  ...
  'landing.funktionen.buchhaltung.title': "Muhasebe ve mali müşavir",
  'landing.funktionen.buchhaltung.desc': "Faturaları DATEV paketi (EXTF) veya evrensel CSV olarak dışa aktarın, sevDesk bağlayın ve analizlerle gelir özeti (EÜR tarzı) elde edin.",
  'landing.funktionen.shop.title': "Mağaza ve pazar yeri",
  'landing.funktionen.shop.desc': "Entegre B2B pazar yeri: malzeme ve filmleri doğrudan toptancılardan sipariş edin. Ayrıca kendi mağazanızda stok yönetimi ve film kütüphanesi.",
  'landing.bundesweit.kicker': "Ülke genelinde",
  'landing.bundesweit.title': "Tüm Almanya'daki işletmeler için",
  'landing.bundesweit.sub': "Kıyıdan Alplere: Detailly, Alman detailing, kaplama ve PPF işletmeleri için üretildi — GoBD, XRechnung ve ZUGFeRD ile.",
  'landing.bundesweit.caption': "Detailing · kaplama · PPF — her posta bölgesinde hazır",
  'landing.bundesweit.aria': "Dağıtılmış bölge noktalarıyla stilize Almanya haritası",
  'landing.finanzShop.kicker': "Sadece işler değil",
  'landing.finanzShop.title': "Muhasebe ve malzeme — doğrudan entegre",
  'landing.finanzShop.buchhaltung.nutzen': "Rakamlarınız doğrudan mali müşavire gider — çift giriş yok.",
  'landing.finanzShop.shop.nutzen': "Yazılımdan çıkmadan malzeme sipariş edin.",
  'landing.dellen.kicker': "Smart Repair / PDR",
  'landing.dellen.title': "Göçüğe tıkla, fiyat hazır",
  'landing.dellen.desc': "Park ve dolu hasarları saniyeler içinde hesaplanır: araçtaki göçüğü işaretleyin — Detailly boyuta, kenara, alüminyuma ve boya hasarına göre anlık fiyatı hesaplar.",
  'landing.dellen.cardHeader': "Göçük hesaplama · PDR",
  'landing.dellen.priceLabel': "Anlık fiyat",
  'landing.dellen.item': "Göçük",
  'landing.dellen.marker1': "Kapı",
  'landing.dellen.marker2': "Çamurluk",
  'landing.dellen.marker3': "Kaput",
  'landing.dellen.note': "Örnek değerler — kendi tarifelerinizi siz belirlersiniz.",
  'landing.dellen.aria': "Resimli göçük hesaplama: üç göçük işaretlenir ve fiyat toplanır.",
