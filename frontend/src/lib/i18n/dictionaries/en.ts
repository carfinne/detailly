...
export const en: Dict = {
  ...
  'plantafel.subtitle': 'Schedule appointments – day, week or month. Drag to move.',
  ...
  'shop.subtitle': 'Products, stock and order approvals',
  ...
  'marktplatz.subtitle': 'Selected offers from our partner dealers – order directly or buy from the dealer.',
