...
export const es: Partial<Dict> = {
  ...
  'landing.bundesweit.kicker': "En toda Alemania",
  'landing.bundesweit.title': "Para talleres de toda Alemania",
  'landing.bundesweit.sub': "De la costa a los Alpes: Detailly está hecho para talleres alemanes de detallado, vinilado y PPF — con GoBD, XRechnung y ZUGFeRD.",
  'landing.bundesweit.caption': "Detallado · vinilado · PPF — listo en cada región postal",
  'landing.bundesweit.aria': "Mapa estilizado de Alemania con puntos regionales distribuidos",
