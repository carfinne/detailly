...
export const es: Partial<Dict> = {
  ...
  'landing.hero.headlinePre': "Vehículo dentro, daño documentado, cliente firma — en ",
  'landing.hero.headlineEm': "cuatro minutos",
  'landing.hero.headlinePost': ".",
  'landing.hero.title1': "Tu oficio es la precisión.",
  'landing.hero.title2': "Ahora tu software también.",
  'landing.hero.sub': "Detailly es el software de taller para detallado, vinilado y PPF: recepción, tablero de planificación, facturación y libro de caja en un solo sistema — demostrable en lugar de de memoria.",
