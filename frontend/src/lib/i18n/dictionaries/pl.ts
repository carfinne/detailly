...
export const pl: Partial<Dict> = {
  ...
  'fahrzeugtyp.label': "Typ pojazdu",
  'fahrzeugtyp.hint': "Wybierz kształt nadwozia dla modelu 3D",
  'fahrzeugtyp.limousine': "Sedan",
  'fahrzeugtyp.kombi': "Kombi",
  'fahrzeugtyp.suv': "SUV/terenowy",
  'fahrzeugtyp.coupe': "Coupé",
  'fahrzeugtyp.kompakt': "Kompakt/miejski",
  'fahrzeugtyp.transporter': "Van/dostawczy",
  'fahrzeugtyp.pickup': "Pickup",
  'fahrzeugtyp.error.save': "Nie udało się zapisać typu pojazdu.",
  // ---- Common --------------------------------------------------------------
  'common.save': 'Zapisz',
  ...
  'nav.group.intake': 'Przyjęcie i kalkulacja',
  ...
  'nav.item.cashbook': 'Księga kasowa',
  ...
  'nav.item.platformGeraetemarkt': 'Moderacja rynku używanych',
  'nav.item.platformSupport': 'Zgłoszenia wsparcia',
  'nav.item.platformSecurity': 'Bezpieczeństwo',
  ...
  'landing.datenblatt.dellen.label': 'Wycena wgnieceń',
  'landing.datenblatt.dellen.fact': 'Smart Repair / PDR · cena od ręki',
  'landing.datenblatt.buchhaltung.label': 'Księgowość',
  'landing.datenblatt.buchhaltung.fact': 'DATEV · sevDesk · CSV',
  'landing.datenblatt.shop.label': 'Sklep i marketplace',
  'landing.datenblatt.shop.fact': 'Zakupy B2B · biblioteka folii',
  ...
  // ---- Strona rezerwacji: tryb prawny (§312j BGB) ---------------------------
  'settings.buchung.modusTitle': 'Zawarcie na stronie rezerwacji',
  'settings.buchung.modusSubtitle': 'Określa, czy Twoja publiczna strona rezerwacji to niezobowiązujące zapytanie, czy wiążąca, płatna rezerwacja.',
  'settings.buchung.modusLabel': 'Tryb',
  'settings.buchung.modusAnfrage': 'Niezobowiązujące zapytanie o termin',
  'settings.buchung.modusVerbindlich': 'Wiążąca, płatna rezerwacja',
  'settings.buchung.modusHelp': 'Zapytanie: klienci wysyłają niezobowiązujące zapytanie – umowa jeszcze nie powstaje, Ty potwierdzasz termin. Wiążąca: online zawierana jest płatna umowa (przycisk „Zamawiam z obowiązkiem zapłaty”, prawo odstąpienia).',
  'settings.buchung.modusVerbindlichHint': 'W trybie wiążącym klienci zawierają z Tobą online płatną umowę na odległość. Dokładnie sprawdź ceny, impressum i pouczenie o odstąpieniu – odpowiedzialność spoczywa na Tobie.',
  'settings.buchung.impressumIncomplete': 'Strona rezerwacji niekompletna: brak danych impressum. Klienci widzą dostawcę (partnera umowy) tylko częściowo. Uzupełnij je w sekcji impressum poniżej.',

  // ---- Publiczna strona rezerwacji: prawo konsumenckie (elementy UI) --------
  // Same teksty prawne (pouczenie/formularz odstąpienia) pozostają PO NIEMIECKU.
  'buchen.recht.badge.anfrage': 'Zapytanie o termin online',
  'buchen.recht.badge.verbindlich': 'Rezerwacja online',
  'buchen.recht.anbieter.title': 'Dostawca',
  'buchen.recht.anbieter.hint': 'Partnerem umowy jest wskazany powyżej zakład, a nie Detailly.',
  'buchen.recht.pflichtinfo.title': 'Twoja rezerwacja w skrócie',
  'buchen.recht.pflichtinfo.leistung': 'Usługa',
  'buchen.recht.pflichtinfo.keineLeistung': 'Nie wybrano usługi',
  'buchen.recht.pflichtinfo.preis': 'Cena',
  'buchen.recht.pflichtinfo.termin': 'Termin',
  'buchen.recht.pflichtinfo.keinTermin': 'Nie wybrano terminu',
  'buchen.recht.pflichtinfo.checkbox': 'Zapoznałem/łam się z informacjami obowiązkowymi i pouczeniem o odstąpieniu.',
  'buchen.recht.pflichtinfo.checkboxError': 'Potwierdź informacje obowiązkowe i pouczenie o odstąpieniu.',
  'buchen.recht.widerruf.title': 'Prawo odstąpienia',
  'buchen.recht.widerruf.deHint': 'Urzędowy tekst prawny jest dostępny tylko po niemiecku.',
  'buchen.recht.widerruf.belehrungLabel': 'Pokaż pouczenie o odstąpieniu',
  'buchen.recht.widerruf.formularLabel': 'Pokaż wzór formularza odstąpienia',
  'buchen.recht.vorzeitig.checkbox': 'Wyraźnie żądam, aby zakład rozpoczął wykonanie przed upływem 14-dniowego terminu odstąpienia. Przyjmuję do wiadomości, że po pełnym wykonaniu umowy tracę prawo odstąpienia.',
  'buchen.recht.vorzeitig.error': 'Zgódź się na wcześniejsze rozpoczęcie wykonania lub wybierz późniejszy termin.',
  'buchen.recht.datenschutz.hintAnfrage': 'Zakład przetwarza Twoje dane w celu obsługi zapytania o termin. Odpowiedzialny jest wskazany powyżej dostawca.',
  'buchen.recht.datenschutz.hintVerbindlich': 'Zakład przetwarza Twoje dane w celu realizacji umowy. Odpowiedzialny jest wskazany powyżej dostawca.',
  'buchen.recht.datenschutz.link': 'Informacje o ochronie danych',
  'buchen.recht.datenschutz.checkbox': 'Zapoznałem/łam się z informacjami o ochronie danych.',
  'buchen.recht.verbindlich.emailRequired': 'Do wiążącej, płatnej rezerwacji potrzebujemy Twojego adresu e-mail – wyślemy tam potwierdzenie rezerwacji i pouczenie o odstąpieniu.',
  'buchen.recht.verbindlich.leistungRequired': 'Wybierz usługę, aby dokonać wiążącej rezerwacji.',
  'buchen.recht.anfrage.hinweis': 'Umowa jeszcze nie powstaje; zakład potwierdzi Twój termin.',
  'buchen.recht.anfrage.button': 'Wyślij niezobowiązujące zapytanie',
  'buchen.recht.anfrage.submitting': 'Wysyłanie…',
  'buchen.recht.verbindlich.intro': 'Klikając, zawierasz z zakładem płatną umowę.',
  'buchen.recht.verbindlich.button': 'Zamawiam z obowiązkiem zapłaty',
  'buchen.recht.verbindlich.submitting': 'Rezerwacja…',
  'buchen.recht.success.anfrage.title': 'Zapytanie wysłane',
  'buchen.recht.success.anfrage.text': 'Dziękujemy! {betrieb} skontaktuje się, aby potwierdzić termin.',
  'buchen.recht.success.verbindlich.title': 'Rezerwacja potwierdzona',
  'buchen.recht.success.verbindlich.text': 'Dziękujemy za płatną rezerwację w {betrieb}. Potwierdzenie z pouczeniem o odstąpieniu otrzymasz e-mailem.',
  'buchen.recht.success.reference': 'Twój numer referencyjny:',
  ...
  // Ustawienia: firma – nawigacja drugorzędna (podsekcje, każda z własnym przyciskiem Zapisz)
  'settings.bereich.navLabel': 'Sekcje ustawień firmy',
  'settings.bereich.stammdaten': 'Dane & marka',
  'settings.bereich.steuer': 'Podatki & stopka',
  'settings.bereich.rechnung': 'Bank & faktura',
  'settings.bereich.kalender': 'Kalkulacja & kalendarz',
  'settings.bereich.email': 'Wysyłka e-mail',
  'settings.bereich.mahnwesen': 'Windykacja',
  'settings.bereich.buchhaltung': 'DATEV & sevDesk',
  'settings.bereich.sicherheit': 'Bezpieczeństwo',

  // Ustawienia: szablony e-maili o statusie (edytowalny temat + treść dla statusu)
  'settings.statusmail.title': 'Szablony e-maili o statusie',
  'settings.statusmail.subtitle': 'Dostosuj temat i treść automatycznych e-maili o statusie do klientów.',
  'settings.statusmail.reviewNote': 'Wyzwalacz wysyłki pozostaje bez zmian: e-maile o statusie wychodzą tylko, gdy przełącznik statusu (komunikacja z klientem) jest włączony. Tutaj zmieniasz wyłącznie treść.',
  'settings.statusmail.placeholders': 'Dostępne symbole zastępcze:',
  'settings.statusmail.status.bestaetigt': 'Zlecenie potwierdzone',
  'settings.statusmail.status.in_arbeit': 'Zlecenie w toku',
  'settings.statusmail.status.abholbereit': 'Pojazd gotowy do odbioru',
  'settings.statusmail.reset': 'Przywróć domyślne',
  'settings.statusmail.subject': 'Temat',
  'settings.statusmail.subjectPlaceholder': 'Pozostaw puste dla domyślnego tematu',
  'settings.statusmail.body': 'Treść',
  'settings.statusmail.bodyPlaceholder': 'Pozostaw puste dla domyślnej treści',
  'settings.statusmail.defaultHint': 'Puste = używany jest sprawdzony tekst domyślny.',
  'settings.statusmail.footerHint': 'Powitanie, link do statusu zlecenia i formuła pożegnalna są dodawane automatycznie – Twój tekst jest pomiędzy.',

  // Ustawienia: preferencje powiadomień dla użytkownika (dzwonek)
  'settings.benachrichtigungen.title': 'Powiadomienia',
  'settings.benachrichtigungen.subtitle': 'Które wskazówki mają pojawiać się w dzwonku.',
  'settings.benachrichtigungen.intro': 'To ustawienie dotyczy tylko Ciebie. Domyślnie wszystkie wskazówki są aktywne.',
  'settings.benachrichtigungen.rechnungenFaellig': 'Zaległe faktury',
  'settings.benachrichtigungen.rechnungenFaelligHint': 'Wskazówka, gdy faktury przekroczyły termin płatności.',
  'settings.benachrichtigungen.termineHeute': 'Dzisiejsze terminy',
  ...
  'settings.benachrichtigungen.auslastungHint': 'Wskazówka, gdy tygodniowe obłożenie jest poniżej Twojego celu.',
  'settings.benachrichtigungen.par19': 'Limit obrotu § 19',
  'settings.benachrichtigungen.par19Hint': 'Ostrzeżenie, gdy zbliżasz się do limitu obrotu małego przedsiębiorcy.',
  ...
  'landing.funktionen.buchhaltung.title': 'Księgowość i biuro rachunkowe',
  'landing.funktionen.buchhaltung.desc': 'Eksportuj faktury jako paczkę DATEV (EXTF) lub uniwersalny CSV, podłącz sevDesk i korzystaj z zestawienia przychodów (typu EÜR) z analizami.',
  'landing.funktionen.shop.title': 'Sklep i marketplace',
  'landing.funktionen.shop.desc': 'Zintegrowany marketplace B2B: zamawiaj materiały i folie bezpośrednio u hurtowników. Do tego stan magazynu i biblioteka folii w Twoim sklepie.',
  'landing.bundesweit.kicker': 'W całych Niemczech',
  'landing.bundesweit.title': 'Dla firm w całych Niemczech',
  'landing.bundesweit.sub': 'Od wybrzeża po Alpy: Detailly jest stworzony dla niemieckich firm detailingowych, oklejających i PPF — z GoBD, XRechnung i ZUGFeRD.',
  'landing.bundesweit.caption': 'Detailing · oklejanie · PPF — gotowe w każdym regionie pocztowym',
  'landing.bundesweit.aria': 'Stylizowana mapa Niemiec z rozmieszczonymi punktami regionów',
  'landing.finanzShop.kicker': 'Więcej niż zlecenia',
  'landing.finanzShop.title': 'Księgowość i materiały — bezpośrednio zintegrowane',
  'landing.finanzShop.buchhaltung.nutzen': 'Twoje liczby trafiają prosto do biura rachunkowego — bez podwójnego wprowadzania.',
  'landing.finanzShop.shop.nutzen': 'Zamawiaj materiały bez opuszczania oprogramowania.',
  'landing.dellen.kicker': 'Smart Repair / PDR',
  'landing.dellen.title': 'Kliknij wgniecenie, cena gotowa',
  'landing.dellen.desc': 'Szkody parkingowe i gradowe wycenione w sekundy: zaznacz wgniecenie na pojeździe — Detailly liczy cenę od ręki według wielkości, krawędzi, aluminium i uszkodzenia lakieru.',
  'landing.dellen.cardHeader': 'Wycena wgnieceń · PDR',
  'landing.dellen.priceLabel': 'Cena od ręki',
  'landing.dellen.item': 'Wgniecenie',
  'landing.dellen.marker1': 'Drzwi',
  'landing.dellen.marker2': 'Błotnik',
  'landing.dellen.marker3': 'Maska',
  'landing.dellen.note': 'Wartości przykładowe — własne stawki ustalasz sam.',
  'landing.dellen.aria': 'Ilustrowana wycena wgnieceń: zaznaczane są trzy wgniecenia, a cena się sumuje.',
  ...
  // Sklep marketplace (PR5): nawigacja kategorii, filtry, sortowanie, szczegóły
  'marktplatz.sort.recommended': 'Polecane',
  'marktplatz.sort.rating': 'Najlepiej oceniane',
  'marktplatz.view.grid': 'Widok siatki',
  'marktplatz.view.list': 'Widok listy',
  'marktplatz.filter.label': 'Filtry',
  'marktplatz.filter.brand': 'Producent',
  'marktplatz.filter.price': 'Cena (€)',
  'marktplatz.filter.priceMin': 'od',
  'marktplatz.filter.priceMax': 'do',
  'marktplatz.filter.availability': 'Dostępność',
  'marktplatz.filter.availAll': 'Wszystkie',
  'marktplatz.filter.more': 'Więcej filtrów',
  'marktplatz.filter.orderableOnly': 'Tylko zamawialne',
  'marktplatz.filter.withSdb': 'Z kartą charakterystyki',
  'marktplatz.filter.origin': 'Kraj pochodzenia',
  'marktplatz.category.all': 'Wszystkie podkategorie',
  'marktplatz.bestand.verfuegbar': 'Dostępny',
  'marktplatz.bestand.wenig': 'Zostało niewiele',
  'marktplatz.bestand.ausverkauft': 'Wyprzedane',
  'marktplatz.badge.sdb': 'KCH',
  'marktplatz.highlight': 'Polecane',
  'marktplatz.highlightsTitle': 'Polecane dla Ciebie',
  'marktplatz.quickView': 'Szybki podgląd',
  'marktplatz.quickView.details': 'Zobacz wszystkie szczegóły',
  'marktplatz.rating.aria': '{schnitt} na 5 gwiazdek ({anzahl} opinii)',
  'marktplatz.rating.stars': '{n} na 5 gwiazdek',
  'marktplatz.detail.back': 'Powrót do marketplace',
  'marktplatz.detail.missingId': 'Nie wybrano produktu.',
  'marktplatz.detail.notFound': 'Produkt nie znaleziony lub niedostępny.',
  'marktplatz.detail.error': 'Nie udało się załadować produktu.',
  'marktplatz.detail.showImage': 'Pokaż zdjęcie {n}',
  'marktplatz.detail.description': 'Opis',
  'marktplatz.detail.usage': 'Wskazówki dotyczące stosowania',
  'marktplatz.detail.techData': 'Dane techniczne',
  'marktplatz.detail.reviews': 'Opinie',
  'marktplatz.detail.noReviews': 'Brak opinii.',
  'marktplatz.detail.verifiedPurchase': 'Zakup zweryfikowany',
  'marktplatz.detail.related': 'Podobne produkty',
  'marktplatz.detail.sdbDownload': 'Karta charakterystyki (PDF)',
  'marktplatz.detail.sdbPending': 'Dla tej kategorii wymagana jest karta charakterystyki – sprzedawca dostarczy ją wkrótce.',
  'marktplatz.detail.sdbError': 'Nie udało się załadować karty charakterystyki.',
  'marktplatz.detail.shipping': 'Wysyłka',
  'marktplatz.detail.freeShipping': 'Bezpłatnie',
  'marktplatz.detail.deliveryTime': 'Czas dostawy',
  ...
  // Panel operatora (PR7): kategorie, moderacja, wyróżnienia, loginy dealerów
  'mpAdmin.tab.kategorien': 'Kategorie',
  'mpAdmin.tab.moderation': 'Moderacja',
  'mpAdmin.save': 'Zapisz',
  'mpAdmin.saving': 'Zapisywanie…',
  'mpAdmin.cancel': 'Anuluj',
  'mpAdmin.cat.new': 'Nowa kategoria',
  'mpAdmin.cat.empty': 'Brak kategorii.',
  'mpAdmin.cat.newTitle': 'Nowa kategoria',
  'mpAdmin.cat.editTitle': 'Edytuj kategorię',
  'mpAdmin.cat.type': 'Typ',
  'mpAdmin.cat.typeHaupt': 'Kategoria główna',
  'mpAdmin.cat.typeUnter': 'Podkategoria',
  'mpAdmin.cat.parent': 'Kategoria nadrzędna',
  'mpAdmin.cat.name': 'Nazwa',
  'mpAdmin.cat.slug': 'Slug',
  'mpAdmin.cat.slugHint': 'Unikalny identyfikator (a–z, 0–9, myślnik). Po utworzeniu niezmienny.',
  'mpAdmin.cat.bereich': 'Obszar',
  'mpAdmin.cat.sortIndex': 'Kolejność',
  'mpAdmin.cat.sdbPflicht': 'Karta charakterystyki wymagana przy produkcie (chemia)',
  'mpAdmin.cat.sdbBadge': 'Wymagana karta',
  'mpAdmin.cat.aktiv': 'Aktywna (widoczna w nawigacji klienta)',
  'mpAdmin.cat.inaktiv': 'Nieaktywna',
  'mpAdmin.cat.edit': 'Edytuj',
  'mpAdmin.cat.deactivate': 'Dezaktywuj',
  'mpAdmin.cat.deactivateTitle': 'Dezaktywuj kategorię',
  'mpAdmin.cat.deactivateText':
    '„{name}” zostanie ukryta w nawigacji klienta. Produkty zachowają przypisanie, a kategorię można ponownie aktywować.',
  'mpAdmin.cat.savedToast': 'Kategoria zapisana',
  'mpAdmin.cat.deactivatedToast': 'Kategoria dezaktywowana',
  'mpAdmin.cat.error': 'Nie udało się zapisać kategorii.',
  'mpAdmin.cat.noParent': 'Najpierw utwórz kategorię główną.',
  'mpAdmin.highlight': 'Wyróżnienie',
  'mpAdmin.highlightOn': 'Oznacz jako wyróżnione',
  'mpAdmin.highlightOff': 'Usuń wyróżnienie',
  'mpAdmin.highlightToast': 'Wyróżnienie zaktualizowane',
  'mpAdmin.highlightError': 'Nie udało się zmienić wyróżnienia.',
  'mpAdmin.mod.empty': 'Brak opinii.',
  'mpAdmin.mod.product': 'Produkt',
  'mpAdmin.mod.haendler': 'Dealer',
  'mpAdmin.mod.rating': 'Ocena',
  'mpAdmin.mod.text': 'Treść',
  'mpAdmin.mod.status': 'Status',
  'mpAdmin.mod.verifiziert': 'Zweryfikowany zakup',
  'mpAdmin.mod.sichtbar': 'Widoczna',
  'mpAdmin.mod.ausgeblendet': 'Ukryta',
  'mpAdmin.mod.ausblenden': 'Ukryj',
  'mpAdmin.mod.einblenden': 'Pokaż',
  'mpAdmin.mod.hideTitle': 'Ukryj opinię',
  'mpAdmin.mod.hideText':
    'Opinia zostanie ukryta i nie będzie liczona do średniej ani liczby. Można ją w każdej chwili ponownie pokazać.',
  'mpAdmin.mod.showTitle': 'Pokaż opinię',
  'mpAdmin.mod.showText': 'Opinia znów staje się widoczna i liczy się do średniej oraz liczby.',
  'mpAdmin.mod.doneToast': 'Opinia zaktualizowana',
  'mpAdmin.mod.error': 'Nie udało się zaktualizować opinii.',
  'mpAdmin.dealer.login': 'Login',
  'mpAdmin.dealer.kontoAktiv': 'Login aktywny',
  'mpAdmin.dealer.kontoInaktiv': 'Login dezaktywowany',
  'mpAdmin.dealer.kontoKeins': 'Brak loginu',
  'mpAdmin.dealer.reinvite': 'Wyślij zaproszenie',
  'mpAdmin.dealer.reinviteTitle': 'Wyślij zaproszenie ponownie',
  'mpAdmin.dealer.reinviteText':
    'Na konto dealera {name} zostanie wysłany nowy e-mail „ustaw hasło”.',
  'mpAdmin.dealer.reinviteToast': 'Zaproszenie wysłane',
  'mpAdmin.dealer.deactivate': 'Dezaktywuj login',
  'mpAdmin.dealer.deactivateTitle': 'Dezaktywuj login dealera',
  'mpAdmin.dealer.deactivateText':
    'Login {name} zostanie dezaktywowany, a wszystkie aktywne sesje natychmiast zakończone. Wpis w katalogu pozostaje.',
  'mpAdmin.dealer.deactivatedToast': 'Login dealera dezaktywowany',
  'mpAdmin.dealer.error': 'Akcja nie powiodła się.',
  ...
  // ---- Rejestr naruszeń danych (art. 33/34 RODO) ---------------------------
  'nav.item.incidents': 'Naruszenia danych',
  'datenpanne.title': 'Rejestr naruszeń danych',
  'datenpanne.subtitle':
    'Rejestruj incydenty i pilnuj 72-godzinnego terminu zgłoszenia (art. 33/34 RODO).',
  'datenpanne.noAccess': 'Tylko właściciel/administrator może przeglądać rejestr naruszeń danych.',
  'datenpanne.new': 'Nowy incydent',
  'datenpanne.empty': 'Brak zarejestrowanych incydentów.',
  'datenpanne.error.load': 'Nie udało się załadować incydentów.',
  ...
  'datenpanne.frist.deadline': 'Termin: {datum}',
  'datenpanne.field.status': 'Status',
  'datenpanne.field.schweregrad': 'Waga',
  'datenpanne.field.kenntnis': 'Powzięcie wiedzy',
  'datenpanne.field.beschreibung': 'Opis incydentu',
  'datenpanne.field.personen': 'Osoby, których dotyczy (ok.)',
  'datenpanne.field.datensaetze': 'Rekordy, których dotyczy (ok.)',
  'datenpanne.field.kategorien': 'Kategorie danych, których dotyczy',
  'datenpanne.field.kategorienHint': 'Oddzielone przecinkami, np. dane kontaktowe, dane pojazdu',
  'datenpanne.field.folgen': 'Prawdopodobne skutki',
  'datenpanne.field.massnahmen': 'Podjęte środki',
  'datenpanne.field.risiko': 'Ocena ryzyka',
  'datenpanne.section.sachverhalt': 'Szczegóły',
  'datenpanne.save': 'Zapisz zmiany',
  'datenpanne.status.erkannt': 'Wykryto',
  'datenpanne.status.in_pruefung': 'W trakcie analizy',
  'datenpanne.status.meldepflichtig': 'Podlega zgłoszeniu',
  'datenpanne.status.gemeldet': 'Zgłoszono',
  'datenpanne.status.nicht_meldepflichtig': 'Nie podlega zgłoszeniu',
  'datenpanne.status.abgeschlossen': 'Zamknięto',
  'datenpanne.schwere.niedrig': 'Niska',
  'datenpanne.schwere.mittel': 'Średnia',
  'datenpanne.schwere.hoch': 'Wysoka',
  'datenpanne.schwere.kritisch': 'Krytyczna',
  'datenpanne.quelle.auto_signal': 'Wykryto automatycznie',
  'datenpanne.quelle.manuell': 'Zarejestrowano ręcznie',
  'datenpanne.quelle.extern_gemeldet': 'Zgłoszono z zewnątrz',
  'datenpanne.quelle.kunde_gemeldet': 'Zgłoszone przez klienta',
  'datenpanne.signal.export_spike': 'Nietypowo wiele eksportów danych',
  'datenpanne.signal.login_bruteforce': 'Liczne nieudane logowania',
  'datenpanne.signal.forbidden_spike': 'Liczne nieautoryzowane próby dostępu',
  'datenpanne.eskalation.title': 'Łańcuch zgłoszeń i eskalacji',
  'datenpanne.eskalation.hint':
    'Nic nie jest wysyłane automatycznie – tutaj tylko dokumentujesz, że/kiedy zgłoszono.',
  'datenpanne.eskalation.verantwortlicher': 'Poinformowano administratora (firmę) (art. 33 ust. 2)',
  'datenpanne.eskalation.behoerde': 'Zgłoszono organowi nadzorczemu (art. 33)',
  'datenpanne.eskalation.betroffene': 'Powiadomiono osoby, których dane dotyczą (art. 34)',
  'datenpanne.meldung.title': 'Szablon zgłoszenia (art. 33)',
  'datenpanne.meldung.hint':
    'Szablon tekstu do sprawdzenia i samodzielnego wysłania – Detailly nic nie wysyła automatycznie.',
  'datenpanne.meldung.generate': 'Utwórz szablon',
  'datenpanne.meldung.copy': 'Kopiuj tekst',
  'datenpanne.meldung.copied': 'Skopiowano do schowka.',
  'datenpanne.meldung.empty': 'Nie utworzono jeszcze szablonu.',
  'datenpanne.create.title': 'Zarejestruj incydent',
  'datenpanne.create.hint':
    '72-godzinny termin biegnie od momentu powzięcia wiedzy (ustawiony na teraz).',
  'datenpanne.create.submit': 'Utwórz incydent',
  'datenpanne.create.saved': 'Incydent utworzony.',
  'datenpanne.create.beschreibungRequired': 'Opisz krótko incydent.',

  // --- Sentinel część 2: widok operatora „Bezpieczeństwo" ---
  'platformSecurity.title': 'Bezpieczeństwo',
  'platformSecurity.subtitle': 'Sentinel – obrona na poziomie aplikacji dla wszystkich firm.',
  'platformSecurity.error.load': 'Nie udało się załadować danych bezpieczeństwa.',
  'platformSecurity.tile.failLogins': 'Błędne logowania (24 h)',
  'platformSecurity.tile.scans': 'Skany 4xx (24 h)',
  'platformSecurity.tile.autoBlocks': 'Auto-blokady (24 h)',
  'platformSecurity.tile.activeBlocks': 'Aktywne blokady',
  'platformSecurity.topIps.title': 'Podejrzane IP',
  'platformSecurity.topIps.subtitle': 'Najwięcej zdarzeń (24 h)',
  'platformSecurity.topIps.empty': 'Brak zdarzeń w ostatnich 24 godzinach.',
  'platformSecurity.blocks.title': 'Blokady IP',
  'platformSecurity.blocks.subtitle': 'Aktualnie aktywne blokady',
  'platformSecurity.blocks.add': 'Zablokuj IP',
  'platformSecurity.blocks.empty': 'Brak aktywnych blokad.',
  'platformSecurity.blocks.until': 'do',
  'platformSecurity.blocks.permanent': 'na stałe',
  'platformSecurity.blocks.system': 'automatycznie',
  'platformSecurity.blocks.manual': 'ręcznie',
  'platformSecurity.blocks.unblock': 'Odblokuj',
  'platformSecurity.blocks.unblockConfirmTitle': 'Odblokować IP?',
  'platformSecurity.blocks.unblockConfirmMsg': 'Blokada dla {ip} zostanie natychmiast zniesiona.',
  'platformSecurity.events.title': 'Zdarzenia bezpieczeństwa',
  'platformSecurity.events.count': 'zdarzeń łącznie',
  'platformSecurity.events.empty': 'Brak zdarzeń dla tego filtra.',
  'platformSecurity.events.filter.allTypes': 'Wszystkie typy',
  'platformSecurity.events.filter.allSeverities': 'Wszystkie poziomy',
  'platformSecurity.events.filter.ip': 'Filtruj IP…',
  'platformSecurity.events.col.time': 'Czas',
  'platformSecurity.events.col.type': 'Typ',
  'platformSecurity.events.col.severity': 'Poziom',
  'platformSecurity.events.col.ip': 'IP',
  'platformSecurity.readonly':
    'Tylko odczyt (analityk/wsparcie): blokowanie/odblokowywanie IP jest zastrzeżone dla administratora platformy.',
  'platformSecurity.block.modalTitle': 'Ręczna blokada IP',
  'platformSecurity.block.ip': 'Adres IP',
  'platformSecurity.block.reason': 'Powód',
  'platformSecurity.block.duration': 'Czas (minuty)',
  'platformSecurity.block.durationHint': 'Puste = 30 dni (dla bezterminowej zaznacz „Na stałe")',
  'platformSecurity.block.permanent': 'Blokuj na stałe (bez wygaśnięcia)',
  'platformSecurity.block.ipInvalid': 'Podaj prawidłowy adres IP.',
  'platformSecurity.block.severity': 'Poziom',
  'platformSecurity.block.submit': 'Zablokuj',
  'platformSecurity.block.success': 'IP zablokowane.',
  'platformSecurity.block.error': 'Akcja nie powiodła się.',
  'platformSecurity.unblock.success': 'Blokada zniesiona.',
  'platformSecurity.eventType.login_fail': 'Błędne logowanie',
  'platformSecurity.eventType.login_lockout': 'Blokada logowania',
  'platformSecurity.eventType.mfa_fail': 'Błąd 2FA',
  'platformSecurity.eventType.scan_4xx': 'Skan 4xx',
  'platformSecurity.eventType.ip_block': 'Blokada IP',
  'platformSecurity.eventType.ip_unblock': 'Odblokowanie IP',
  'platformSecurity.severity.info': 'Info',
  'platformSecurity.severity.warn': 'Ostrzeżenie',
  'platformSecurity.severity.critical': 'Krytyczne',
  // ---- Kokpit operatora (podstawowe klucze; reszta wraca do DE) -------------
  'cockpit.title': 'Kokpit operatora',
  'cockpit.subtitle': 'Platforma Detailly – metryki na żywo, lokalizacje i firmy.',
  'cockpit.error.load': 'Nie udało się załadować danych kokpitu.',
  'cockpit.common.yes': 'Tak',
  'cockpit.tab.uebersicht': 'Przegląd',
  'cockpit.tab.standorte': 'Lokalizacje',
  'cockpit.tab.betriebe': 'Firmy',
  'cockpit.tab.protokoll': 'Dziennik',
  'cockpit.live.title': 'Metryki na żywo',
  'cockpit.live.subtitle': 'W czasie rzeczywistym dla wszystkich firm platformy.',
  'cockpit.kpi.tenants': 'Firmy łącznie',
  'cockpit.kpi.trials': 'Kończące się okresy próbne',
  'cockpit.kpi.trialsHint': 'w ciągu najbliższych 7 dni',
  'cockpit.kpi.activeUsers': 'Aktywni użytkownicy (24 h)',
  'cockpit.kpi.tickets': 'Otwarte zgłoszenia',
  'cockpit.hub.title': 'Szybki dostęp',
  'cockpit.hub.subtitle': 'Obszary specjalne platformy.',
  'cockpit.hub.open': 'Otwórz',
  'cockpit.hub.support': 'Wsparcie',
  'cockpit.hub.supportHint': 'Odpowiadaj na zgłoszenia wszystkich firm',
  'cockpit.hub.marketplace': 'Marketplace',
  'cockpit.hub.marketplaceHint': 'Weryfikuj i zarządzaj wnioskami hurtowników',
  'cockpit.hub.newsletter': 'Newsletter',
  'cockpit.hub.newsletterHint': 'Wyślij nowości produktowe do wszystkich firm',
  'cockpit.loc.empty': 'Brak danych o lokalizacjach.',
  'cockpit.loc.total': 'Firmy z lokalizacją',
  'cockpit.loc.regions': 'Regiony pocztowe',
  'cockpit.loc.region': 'Kod {region}',
  'cockpit.tenants.searchPlaceholder': 'Szukaj firmy (nazwa, miasto, e-mail)…',
  'cockpit.tenants.filter.alle': 'Wszystkie',
  'cockpit.tenants.empty': 'Brak firm.',
  'cockpit.tenants.emptyFiltered': 'Brak firm dla tego wyszukiwania.',
  'cockpit.tenants.col.name': 'Firma',
  'cockpit.tenants.col.typ': 'Typ',
  'cockpit.tenants.col.status': 'Status',
  'cockpit.tenants.col.nutzer': 'Użytkownicy',
  'cockpit.tenants.col.abo': 'Subskrypcja',
  'cockpit.tenantStatus.active': 'Aktywna',
  'cockpit.tenantStatus.trial': 'Okres próbny',
  'cockpit.tenantStatus.inactive': 'Nieaktywna',
  'cockpit.audit.title': 'Dziennik audytu',
  'cockpit.audit.subtitle': 'Widok całej platformy (tylko administrator platformy).',
  'cockpit.audit.empty': 'Brak wpisów w dzienniku.',
  'cockpit.lookup.title': 'Znajdź użytkownika po e-mailu',
  'cockpit.lookup.placeholder': 'Adres e-mail (min. 3 znaki)…',
  // ---- Portal sprzedawcy (zalogowany, rozbudowa marketplace PR8) ------------
  'haendlerportal.eyebrow': 'Detailly · Portal sprzedawcy',
  'haendlerportal.provision': 'Prowizja dla Detailly: {satz}% od zamówienia',
  'haendlerportal.logout': 'Wyloguj',
  'haendlerportal.guard.checking': 'Sprawdzanie dostępu…',
  'haendlerportal.loading': 'Ładowanie portalu…',
  'haendlerportal.error.noAccess': 'To konto nie ma dostępu sprzedawcy.',
  'haendlerportal.error.load': 'Nie udało się załadować portalu. Spróbuj ponownie później.',
  'haendlerportal.tab.overview': 'Przegląd',
  'haendlerportal.tab.products': 'Produkty ({n})',
  'haendlerportal.tab.orders': 'Zamówienia',
  'haendlerportal.tab.ordersNew': 'Zamówienia ({n} nowych)',
  'haendlerportal.kpi.products': 'Produkty',
  'haendlerportal.kpi.productsActive': '{n} aktywnych',
  'haendlerportal.kpi.ordersOpen': 'Otwarte zamówienia',
  'haendlerportal.kpi.ordersTotal': 'Zamówienia łącznie',
  'haendlerportal.overview.recentOrders': 'Ostatnie zamówienia',
  'haendlerportal.overview.allOrders': 'Zobacz wszystkie',
  'haendlerportal.orders.empty': 'Brak zamówień.',
  'haendlerportal.orders.confirm': 'Potwierdź',
  'haendlerportal.orders.cancel': 'Anuluj',
  'haendlerportal.orders.ship': 'Oznacz jako wysłane',
  'haendlerportal.orders.statusSaved': 'Status zaktualizowany.',
  'haendlerportal.orders.statusError': 'Nie udało się zmienić statusu.',
  'haendlerportal.status.eingegangen': 'Otrzymane',
  'haendlerportal.status.bestaetigt': 'Potwierdzone',
  'haendlerportal.status.versendet': 'Wysłane',
  'haendlerportal.status.storniert': 'Anulowane',
  'haendlerportal.products.new': '+ Dodaj nowy produkt',
  'haendlerportal.products.editTitle': 'Edytuj produkt',
  'haendlerportal.products.newTitle': 'Nowy produkt',
  'haendlerportal.products.saved': 'Produkt zapisany.',
  'haendlerportal.products.saveError': 'Zapis nie powiódł się.',
  'haendlerportal.products.saving': 'Zapisywanie…',
  'haendlerportal.products.empty': 'Nie dodano jeszcze żadnych produktów.',
  'haendlerportal.products.edit': 'Edytuj',
  'haendlerportal.products.activate': 'Aktywuj',
  'haendlerportal.products.deactivate': 'Dezaktywuj',
  'haendlerportal.products.activated': 'Produkt aktywowany.',
  'haendlerportal.products.deactivated': 'Produkt dezaktywowany.',
  'haendlerportal.products.inactive': 'nieaktywny',
  'haendlerportal.products.orderable': 'można zamówić',
  'haendlerportal.products.footerHint':
    'Zmiany pojawiają się w marketplace Detailly natychmiast. Produkty do zamówienia wymagają stałej ceny, pozostałe — linku do sklepu/afiliacyjnego.',
  'haendlerportal.field.name': 'Nazwa',
  'haendlerportal.field.bereich': 'Obszar',
  'haendlerportal.field.marke': 'Marka (np. 3M, Koch Chemie)',
  'haendlerportal.field.kategorie': 'Grupa produktów (dowolny tekst)',
  'haendlerportal.field.preis': 'Cena (EUR)',
  'haendlerportal.field.preisHinweis': 'Uwaga do ceny (np. „za rolkę”)',
  'haendlerportal.field.bildUrl': 'URL obrazu (https)',
  'haendlerportal.field.affiliateUrl': 'Zewnętrzny link do sklepu/afiliacyjny (opcjonalnie)',
  'haendlerportal.field.beschreibung': 'Opis',
  'haendlerportal.field.bestellbar': 'Można zamówić bezpośrednio przez Detailly (wymagana stała cena)',
  'haendlerportal.uploads.saveFirst':
    'Najpierw zapisz produkt — obrazy i kartę charakterystyki można dodać później.',
  'haendlerportal.images.title': 'Zdjęcia produktu',
  'haendlerportal.images.hint': 'JPEG, PNG lub WebP · maks. 5 MB · do {n} zdjęć',
  'haendlerportal.images.drop': 'Przeciągnij zdjęcia tutaj lub wybierz',
  'haendlerportal.images.choose': 'Wybierz zdjęcia',
  'haendlerportal.images.uploading': 'Przesyłanie zdjęć…',
  'haendlerportal.images.uploaded': 'Zdjęcia dodane.',
  'haendlerportal.images.delete': 'Usuń zdjęcie',
  'haendlerportal.images.errorType': 'Dozwolone są tylko zdjęcia JPEG, PNG lub WebP.',
  'haendlerportal.images.errorSize': 'Jedno ze zdjęć jest za duże (maks. 5 MB).',
  'haendlerportal.images.max': 'Maksymalnie {n} zdjęć na produkt.',
  'haendlerportal.sdb.badge': 'KCH',
  'haendlerportal.sdb.title': 'Karta charakterystyki (KCH)',
  'haendlerportal.sdb.present': 'dodana',
  'haendlerportal.sdb.none': 'brak',
  'haendlerportal.sdb.legal':
    'Dla chemikaliów i substancji niebezpiecznych karta charakterystyki jest wymagana prawem (REACH/CLP — obowiązek dostawcy).',
  'haendlerportal.sdb.softRequire':
    'Produkty bez karty charakterystyki można zapisać, ale należy je aktywować dopiero po jej przesłaniu.',
  'haendlerportal.sdb.upload': 'Prześlij PDF',
  'haendlerportal.sdb.replace': 'Zamień KCH',
  'haendlerportal.sdb.download': 'Zobacz KCH',
  'haendlerportal.sdb.uploaded': 'Karta charakterystyki zapisana.',
  'haendlerportal.sdb.errorType': 'Karta charakterystyki musi być plikiem PDF.',
  'haendlerportal.sdb.errorSize': 'Plik jest za duży (maks. 10 MB).',
  'haendlerportal.upload.error': 'Przesyłanie nie powiodło się.',
  // PR9: nowe edytowalne pola katalogu w formularzu produktu
  'haendlerportal.section.category': 'Klasyfikacja',
  'haendlerportal.section.shipping': 'Wysyłka i stan magazynowy',
  'haendlerportal.section.details': 'Szczegóły',
  'haendlerportal.field.categoryLabel': 'Kategoria',
  'haendlerportal.field.categoryNone': '— brak kategorii —',
  'haendlerportal.field.categoryMain': '{name} (grupa główna)',
  'haendlerportal.field.categorySdbHint': 'Ta kategoria wymaga karty charakterystyki (SDS).',
  'haendlerportal.field.herkunftsland': 'Kraj pochodzenia',
  'haendlerportal.field.herkunftslandNone': '— brak danych —',
  'haendlerportal.field.versandKosten': 'Koszt wysyłki (EUR)',
  'haendlerportal.field.versandHinweis': 'Uwaga dot. wysyłki',
  'haendlerportal.field.lieferzeitTage': 'Czas dostawy (dni)',
  'haendlerportal.field.bestand': 'Stan magazynowy',
  'haendlerportal.field.bestandHint': 'Puste = nieograniczony/nieznany',
  'haendlerportal.field.anwendungshinweise': 'Wskazówki dotyczące stosowania',
  'haendlerportal.field.inhaltMenge': 'Zawartość/opakowanie (np. „500 ml”)',
  'haendlerportal.tech.title': 'Dane techniczne',
  'haendlerportal.tech.hint': 'Jako cecha i wartość, np. „Grubość folii” → „150 µm”.',
  'haendlerportal.tech.key': 'Cecha',
  'haendlerportal.tech.value': 'Wartość',
  'haendlerportal.tech.add': '+ Dodaj cechę',
  'haendlerportal.tech.remove': 'Usuń',
  // ---- Rynek używanego sprzętu --------------------------------------------
  'nav.item.geraetemarkt': 'Rynek używanych',
  'geraetemarkt.title': 'Rynek używanych',
  'geraetemarkt.subtitle': 'Używany sprzęt i narzędzia od zweryfikowanych firm – kup i wystaw.',
  'geraetemarkt.myListings': 'Moje ogłoszenia',
  'geraetemarkt.newListing': 'Wystaw ogłoszenie',
  'geraetemarkt.resultCount': '{count} ogłoszeń',
  'geraetemarkt.resetFilter': 'Wyczyść filtry',
  'geraetemarkt.badge.verified': 'Firma · zweryfikowany zakład',
  'geraetemarkt.badge.verifiedLong': 'Sprzedawca to zweryfikowana firma.',
  'geraetemarkt.error.load': 'Nie udało się załadować rynku używanych.',
  'geraetemarkt.empty.none': 'Brak ogłoszeń. Zajrzyj później.',
  'geraetemarkt.empty.filtered': 'Brak ogłoszeń dla tych filtrów.',
  'geraetemarkt.filter.allCategories': 'Wszystkie kategorie',
  'geraetemarkt.filter.condition': 'Stan',
  'geraetemarkt.filter.any': 'Wszystkie',
  'geraetemarkt.filter.region': 'Region',
  'geraetemarkt.filter.regionPlaceholder': 'Kod',
  'geraetemarkt.filter.regionAria': 'Filtruj region po 2-cyfrowym kodzie pocztowym',
  'geraetemarkt.sort.label': 'Sortowanie',
  'geraetemarkt.sort.neu': 'Najnowsze',
  'geraetemarkt.sort.preis_auf': 'Cena rosnąco',
  'geraetemarkt.sort.preis_ab': 'Cena malejąco',
  'geraetemarkt.kategorie.poliermaschine': 'Polerka',
  'geraetemarkt.kategorie.sauger_extraktor': 'Odkurzacz i ekstraktor',
  'geraetemarkt.kategorie.plotter': 'Ploter tnący',
  'geraetemarkt.kategorie.ir_kurzwellen_trockner': 'Promiennik IR / krótkofalowy',
  'geraetemarkt.kategorie.hebebuehne': 'Podnośnik',
  'geraetemarkt.kategorie.folier_werkzeug': 'Narzędzia do foliowania',
  'geraetemarkt.kategorie.druckluft_kompressor': 'Sprężone powietrze i kompresor',
  'geraetemarkt.kategorie.dampfreiniger': 'Myjka parowa',
  'geraetemarkt.kategorie.messtechnik': 'Technika pomiarowa',
  'geraetemarkt.kategorie.sonstiges_geraet': 'Inny sprzęt',
  'geraetemarkt.zustand.neu': 'Nowy',
  'geraetemarkt.zustand.gebraucht': 'Używany',
  'geraetemarkt.zustand.defekt': 'Uszkodzony',
  'geraetemarkt.status.aktiv': 'Aktywne',
  'geraetemarkt.status.reserviert': 'Zarezerwowane',
  'geraetemarkt.status.verkauft': 'Sprzedane',
  'geraetemarkt.status.entfernt': 'Usunięte',
  'geraetemarkt.preisModus.fest': 'Cena stała',
  'geraetemarkt.preisModus.vb': 'Do negocjacji',
  'geraetemarkt.preisModus.anfrage': 'Cena na zapytanie',
  'geraetemarkt.preisModus.vbShort': 'do neg.',
  'geraetemarkt.detail.backToBrowse': 'Wróć do rynku używanych',
  'geraetemarkt.detail.notFoundTitle': 'Nie znaleziono ogłoszenia',
  'geraetemarkt.detail.notFound': 'To ogłoszenie nie jest już dostępne.',
  'geraetemarkt.detail.region': 'Region',
  'geraetemarkt.detail.listedOn': 'Wystawiono',
  'geraetemarkt.detail.contactTitle': 'Skontaktuj się ze sprzedawcą',
  'geraetemarkt.detail.descriptionTitle': 'Opis',
  'geraetemarkt.detail.showContact': 'Pokaż kontakt',
  'geraetemarkt.detail.contactLoading': 'Ładowanie kontaktu…',
  'geraetemarkt.detail.contactError': 'Nie udało się załadować kontaktu.',
  'geraetemarkt.detail.revealHint': 'Kontakt firmy zostanie wyświetlony; ujawnienie jest rejestrowane.',
  'geraetemarkt.detail.email': 'E-mail',
  'geraetemarkt.detail.phone': 'Telefon',
  'geraetemarkt.detail.address': 'Adres',
  'geraetemarkt.detail.noContactData': 'Dla tej firmy nie zapisano danych kontaktowych.',
  'geraetemarkt.detail.offAppHint': 'Transakcja odbywa się bezpośrednio między firmami. Detailly tylko pośredniczy w kontakcie i nie obsługuje płatności.',
  'geraetemarkt.meine.subtitle': 'Zarządzaj wystawionym sprzętem.',
  'geraetemarkt.meine.toBrowse': 'Do rynku używanych',
  'geraetemarkt.meine.empty': 'Nie masz jeszcze żadnych ogłoszeń.',
  'geraetemarkt.meine.statusUpdated': 'Zaktualizowano status.',
  'geraetemarkt.meine.statusError': 'Nie udało się zmienić statusu.',
  'geraetemarkt.meine.deleted': 'Ogłoszenie usunięte.',
  'geraetemarkt.meine.deleteError': 'Nie udało się usunąć ogłoszenia.',
  'geraetemarkt.meine.deleteTitle': 'Usuń ogłoszenie',
  'geraetemarkt.meine.deleteConfirm': 'Trwale usunąć „{titel}”?',
  'geraetemarkt.meine.action.reserve': 'Zarezerwuj',
  'geraetemarkt.meine.action.reactivate': 'Aktywuj ponownie',
  'geraetemarkt.meine.action.markSold': 'Oznacz jako sprzedane',
  'geraetemarkt.meine.action.republish': 'Wystaw ponownie',
  'geraetemarkt.meine.action.edit': 'Edytuj',
  'geraetemarkt.meine.action.delete': 'Usuń',
  'geraetemarkt.form.roleHint': 'Ogłoszenia może wystawiać i zarządzać nimi tylko kierownictwo (właściciel lub menedżer).',
  'geraetemarkt.form.createTitle': 'Wystaw ogłoszenie',
  'geraetemarkt.form.editTitle': 'Edytuj ogłoszenie',
  'geraetemarkt.form.subtitle': 'Opisz sprzęt możliwie dokładnie – to buduje zaufanie i ogranicza pytania.',
  'geraetemarkt.form.chemieTitle': 'Tylko sprzęt i narzędzia — ŻADNEJ chemii ani materiałów eksploatacyjnych',
  'geraetemarkt.form.chemieHint': 'Pasty polerskie, powłoki, środki czyszczące i inne materiały eksploatacyjne/niebezpieczne nie są dozwolone na rynku używanych.',
  'geraetemarkt.form.sectionBasics': 'Dane podstawowe',
  'geraetemarkt.form.titel': 'Tytuł',
  'geraetemarkt.form.titelPlaceholder': 'np. polerka Rupes BigFoot LHR21',
  'geraetemarkt.form.kategorie': 'Kategoria',
  'geraetemarkt.form.zustand': 'Stan',
  'geraetemarkt.form.beschreibung': 'Opis',
  'geraetemarkt.form.beschreibungPlaceholder': 'Model, wiek, akcesoria, ślady użytkowania, powód sprzedaży …',
  'geraetemarkt.form.beschreibungHelp': 'Im więcej szczegółów, tym mniej pytań. Nie podawaj tu danych kontaktowych.',
  'geraetemarkt.form.sectionPrice': 'Cena',
  'geraetemarkt.form.preisModus': 'Rodzaj ceny',
  'geraetemarkt.form.preis': 'Cena',
  'geraetemarkt.form.sectionLocation': 'Lokalizacja',
  'geraetemarkt.form.locationSubtitle': 'Tylko ogólnie – 2-cyfrowy region kodu i opcjonalnie miejscowość.',
  'geraetemarkt.form.plz': 'Region kodu',
  'geraetemarkt.form.plzHelp': 'Tylko pierwsze 2 cyfry kodu pocztowego.',
  'geraetemarkt.form.ort': 'Miejscowość (opcjonalnie)',
  'geraetemarkt.form.ortPlaceholder': 'np. okolice Monachium',
  'geraetemarkt.form.sectionImages': 'Zdjęcia',
  'geraetemarkt.form.imagesSubtitle': 'Do {max} zdjęć (JPEG, PNG lub WebP).',
  'geraetemarkt.form.dropzone': 'Przeciągnij zdjęcia tutaj lub kliknij, aby wybrać',
  'geraetemarkt.form.dropzoneHint': '{count} z {max} zdjęć',
  'geraetemarkt.form.imagesFull': 'Osiągnięto maksimum {max} zdjęć',
  'geraetemarkt.form.removeImage': 'Usuń zdjęcie',
  'geraetemarkt.form.confirm': 'Oferuję jako przedsiębiorca, moje dane są poprawne i sprzedaję wyłącznie sprzęt/narzędzia (bez chemii/materiałów eksploatacyjnych).',
  'geraetemarkt.form.publish': 'Opublikuj ogłoszenie',
  'geraetemarkt.form.saveEdit': 'Zapisz zmiany',
  'geraetemarkt.form.created': 'Ogłoszenie opublikowane.',
  'geraetemarkt.form.saved': 'Zmiany zapisane.',
  'geraetemarkt.form.saveError': 'Nie udało się zapisać ogłoszenia.',
  'geraetemarkt.form.uploadError': 'Nie udało się przesłać zdjęć.',
  'geraetemarkt.form.deleteImageError': 'Nie udało się usunąć zdjęcia.',
  'geraetemarkt.form.error.titelRequired': 'Podaj tytuł.',
  'geraetemarkt.form.error.titelMax': 'Tytuł może mieć maksymalnie 120 znaków.',
  'geraetemarkt.form.error.beschreibungRequired': 'Podaj opis.',
  'geraetemarkt.form.error.beschreibungMax': 'Opis może mieć maksymalnie 4000 znaków.',
  'geraetemarkt.form.error.preisRequired': 'Podaj cenę.',
  'geraetemarkt.form.error.preisRange': 'Podaj prawidłową cenę.',
  'geraetemarkt.form.error.plz': 'Podaj dokładnie 2 cyfry.',
  'geraetemarkt.form.error.ortMax': 'Miejscowość może mieć maksymalnie 120 znaków.',
  'geraetemarkt.form.error.confirm': 'Potwierdź dane, aby kontynuować.',
  'geraetemarkt.form.error.imageType': 'Dozwolone są tylko zdjęcia JPEG, PNG lub WebP.',
  'geraetemarkt.form.error.imageMax': 'Maksymalnie {max} zdjęć na ogłoszenie.',

  // ---- Księga kasowa (GoBD, płatności gotówkowe) ---------------------------
  'kassenbuch.title': 'Księga kasowa',
  'kassenbuch.subtitle': 'Rejestruj, blokuj i eksportuj wpływy i wypłaty gotówkowe zgodnie z GoBD.',
  'kassenbuch.stat.balance': 'Stan kasy',
  'kassenbuch.stat.balanceHint': 'Gotówka w kasie',
  'kassenbuch.stat.dayIn': 'Wpływy dziś',
  'kassenbuch.stat.dayOut': 'Wydatki dziś',
  'kassenbuch.stat.monthSaldo': 'Saldo miesiąca',
  'kassenbuch.add': 'Dodaj wpis',
  'kassenbuch.addTitle': 'Wpis księgi kasowej',
  'kassenbuch.editTitle': 'Edytuj wpis',
  'kassenbuch.type.einnahme': 'Wpływ',
  'kassenbuch.type.ausgabe': 'Wydatek',
  'kassenbuch.filter.from': 'Od',
  'kassenbuch.filter.to': 'Do',
  'kassenbuch.filter.type': 'Rodzaj',
  'kassenbuch.filter.all': 'Wszystkie',
  'kassenbuch.filter.reset': 'Wyczyść filtry',
  'kassenbuch.col.number': 'Nr',
  'kassenbuch.col.date': 'Data',
  'kassenbuch.col.type': 'Rodzaj',
  'kassenbuch.col.purpose': 'Cel',
  'kassenbuch.col.amount': 'Kwota',
  'kassenbuch.col.balance': 'Stan',
  'kassenbuch.col.status': 'Status',
  'kassenbuch.col.actions': 'Akcje',
  'kassenbuch.status.draft': 'Wersja robocza',
  'kassenbuch.status.locked': 'Zablokowany',
  'kassenbuch.badge.storno': 'Storno do nr {nr}',
  'kassenbuch.form.type': 'Rodzaj',
  'kassenbuch.form.amount': 'Kwota (€)',
  'kassenbuch.form.purpose': 'Cel / tytuł',
  'kassenbuch.form.vat': 'Stawka VAT',
  'kassenbuch.form.receiptNo': 'Numer dowodu',
  'kassenbuch.form.category': 'Kategoria',
  'kassenbuch.form.date': 'Data księgowania',
  'kassenbuch.form.optional': 'opcjonalnie',
  'kassenbuch.form.save': 'Zapisz',
  'kassenbuch.form.error.amount': 'Podaj kwotę większą niż 0.',
  'kassenbuch.form.error.purpose': 'Podaj cel.',
  'kassenbuch.action.edit': 'Edytuj',
  'kassenbuch.action.delete': 'Usuń',
  'kassenbuch.action.storno': 'Stornuj',
  'kassenbuch.action.lock': 'Zablokuj',
  'kassenbuch.lock.title': 'Zablokować do tego miejsca?',
  'kassenbuch.lock.message': 'Ten wpis oraz wszystkie wcześniejsze otwarte wpisy zostaną zablokowane i staną się niezmienialne (korekta tylko przez storno).',
  'kassenbuch.lock.confirm': 'Zablokuj',
  'kassenbuch.lockAll': 'Zamknięcie dnia',
  'kassenbuch.lockAll.title': 'Zablokować wszystkie wersje robocze?',
  'kassenbuch.lockAll.message': 'Wszystkie otwarte wpisy zostaną zablokowane i staną się niezmienialne (korekta tylko przez storno).',
  'kassenbuch.lockAll.confirm': 'Zablokuj wszystkie',
  'kassenbuch.lockAll.none': 'Brak otwartych wersji roboczych do zablokowania.',
  'kassenbuch.delete.title': 'Usunąć wpis?',
  'kassenbuch.delete.message': 'Ta wersja robocza zostanie trwale usunięta. Usunąć można tylko ostatni, jeszcze niezablokowany wpis.',
  'kassenbuch.delete.confirm': 'Usuń',
  'kassenbuch.storno.title': 'Stornować wpis?',
  'kassenbuch.storno.message': 'Tworzony jest wpis storno z odwrotnym rodzajem księgowania. Pierwotny wpis pozostaje bez zmian (GoBD).',
  'kassenbuch.storno.confirm': 'Stornuj',
  'kassenbuch.export': 'Eksport CSV',
  'kassenbuch.exporting': 'Eksportowanie…',
  'kassenbuch.empty': 'Brak wpisów w księdze kasowej. Zarejestruj pierwszy ruch gotówkowy.',
  'kassenbuch.page': 'Strona',
  'kassenbuch.toast.created': 'Wpis zarejestrowany.',
  'kassenbuch.toast.updated': 'Wpis zaktualizowany.',
  'kassenbuch.toast.deleted': 'Wpis usunięty.',
  'kassenbuch.toast.locked': 'Wpis zablokowany.',
  'kassenbuch.toast.lockedAll': 'Zablokowano wpisy: {count}.',
  'kassenbuch.toast.storno': 'Utworzono wpis storno.',
  'kassenbuch.toast.exported': 'Wyeksportowano księgę kasową.',
  'kassenbuch.error.load': 'Nie udało się wczytać księgi kasowej.',
  'kassenbuch.error.generic': 'Akcja nie powiodła się. Spróbuj ponownie.',
  // ---- Rynek używanych · zasady + zgłaszanie (PR5) ------------------------
  'geraetemarkt.rules.link': 'Zasady rynku i informacje prawne',
  'geraetemarkt.melden.report': 'Zgłoś',
  'geraetemarkt.melden.done': 'Zgłoszono',
  'geraetemarkt.melden.title': 'Zgłoś ogłoszenie',
  'geraetemarkt.melden.intro': 'Dlaczego chcesz zgłosić to ogłoszenie? Zgłoszenie trafi do zespołu Detailly.',
  'geraetemarkt.melden.reasonLabel': 'Powód',
  'geraetemarkt.melden.grund.chemie_verboten': 'Chemia/materiały eksploatacyjne (niedozwolone)',
  'geraetemarkt.melden.grund.spam': 'Spam lub reklama',
  'geraetemarkt.melden.grund.betrug': 'Podejrzenie oszustwa',
  'geraetemarkt.melden.grund.unangemessen': 'Nieodpowiednia treść',
  'geraetemarkt.melden.grund.sonstiges': 'Inne',
  'geraetemarkt.melden.commentLabel': 'Komentarz (opcjonalnie)',
  'geraetemarkt.melden.commentPlaceholder': 'Krótki opis problemu …',
  'geraetemarkt.melden.submit': 'Wyślij zgłoszenie',
  'geraetemarkt.melden.sending': 'Wysyłanie …',
  'geraetemarkt.melden.success': 'Dziękujemy – Twoje zgłoszenie zostało przyjęte.',
  'geraetemarkt.melden.already': 'To ogłoszenie zostało już przez Ciebie zgłoszone.',
  'geraetemarkt.melden.error': 'Nie udało się wysłać zgłoszenia.',
  // ---- Moderacja rynku używanych (role platformy) -------------------------
  'plattformGeraetemarkt.title': 'Moderacja rynku używanych',
  'plattformGeraetemarkt.subtitle': 'Sprawdzaj, ukrywaj lub usuwaj zgłoszone i podejrzane ogłoszenia.',
  'plattformGeraetemarkt.noAccess': 'Ten obszar jest zastrzeżony dla zespołu platformy Detailly.',
  'plattformGeraetemarkt.readonlyHint': 'Masz dostęp tylko do odczytu. Działania moderacyjne są zastrzeżone dla administratora i wsparcia platformy.',
  'plattformGeraetemarkt.error.load': 'Nie udało się załadować danych moderacji.',
  'plattformGeraetemarkt.actionError': 'Nie udało się wykonać działania.',
  'plattformGeraetemarkt.tab.meldungen': 'Zgłoszenia',
  'plattformGeraetemarkt.tab.inserate': 'Ogłoszenia',
  'plattformGeraetemarkt.meldStatus.offen': 'Otwarte',
  'plattformGeraetemarkt.meldStatus.erledigt': 'Załatwione',
  'plattformGeraetemarkt.meldStatus.verworfen': 'Odrzucone',
  'plattformGeraetemarkt.modStatus.ok': 'Widoczne',
  'plattformGeraetemarkt.modStatus.verborgen': 'Ukryte',
  'plattformGeraetemarkt.modStatus.entfernt': 'Usunięte',
  'plattformGeraetemarkt.meldungen.filterLabel': 'Status',
  'plattformGeraetemarkt.meldungen.empty': 'Brak zgłoszeń w tym widoku.',
  'plattformGeraetemarkt.meldungen.systemLabel': 'Automatyczna kontrola wstępna',
  'plattformGeraetemarkt.meldungen.reportedAt': 'Zgłoszono {datum}',
  'plattformGeraetemarkt.meldungen.comment': 'Komentarz',
  'plattformGeraetemarkt.meldungen.inseratGone': 'Zgłoszone ogłoszenie już nie istnieje.',
  'plattformGeraetemarkt.meldungen.dismiss': 'Odrzuć',
  'plattformGeraetemarkt.meldungen.markDone': 'Załatw',
  'plattformGeraetemarkt.inserate.filterLabel': 'Moderacja',
  'plattformGeraetemarkt.inserate.filterAll': 'Wszystkie',
  'plattformGeraetemarkt.inserate.empty': 'Brak ogłoszeń w tym widoku.',
  'plattformGeraetemarkt.action.hide': 'Ukryj',
  'plattformGeraetemarkt.action.remove': 'Usuń',
  'plattformGeraetemarkt.action.restore': 'Przywróć',
  'plattformGeraetemarkt.action.viewInserat': 'Otwórz ogłoszenie',
  'plattformGeraetemarkt.confirm.hideTitle': 'Ukryj ogłoszenie',
  'plattformGeraetemarkt.confirm.hideText': '„{titel}" zostanie ukryte dla innych firm. Kontynuować?',
  'plattformGeraetemarkt.confirm.removeTitle': 'Usuń ogłoszenie',
  'plattformGeraetemarkt.confirm.removeText': '„{titel}" zostanie trwale usunięte z rynku używanych. Kontynuować?',
  'plattformGeraetemarkt.toast.moderated': 'Zaktualizowano status moderacji.',
  'plattformGeraetemarkt.toast.meldungDone': 'Zgłoszenie oznaczone jako załatwione.',
  'plattformGeraetemarkt.toast.meldungDismissed': 'Zgłoszenie odrzucone.',
  'plattformGeraetemarkt.table.listing': 'Ogłoszenie',
  'plattformGeraetemarkt.table.category': 'Kategoria',
  'plattformGeraetemarkt.table.status': 'Status',
  'plattformGeraetemarkt.table.moderation': 'Moderacja',
  'plattformGeraetemarkt.table.createdAt': 'Wystawiono',

  // ---- Program polecający --------------------------------------------------
  'common.optional': 'opcjonalnie',
  'nav.item.affiliate': 'Poleć nas',
  'cockpit.tab.empfehlungen': 'Polecenia',
  'cockpit.referrals.title': 'Polecenia',
  'cockpit.referrals.subtitle': 'Kto kogo polecił – wraz z naliczonymi bonusami (tylko podgląd).',
  'cockpit.referrals.empty': 'Brak zarejestrowanych poleceń.',
  'cockpit.referrals.col.referrer': 'Polecający',
  'cockpit.referrals.col.referred': 'Polecony warsztat',
  'cockpit.referrals.col.status': 'Status',
  'cockpit.referrals.col.reward': 'Bonus',
  'cockpit.referrals.col.date': 'Data polecenia',
  // ---- Rejestr analizy rynku (kokpit, wewnętrzny dla operatora) -----------
  'cockpit.tab.marktregister': 'Rejestr rynku',
  'marktregister.title': 'Rejestr analizy rynku',
  'marktregister.subtitle':
    'Wewnętrzna, neutralna obserwacja konkurencji: rzeczowe, publicznie dostępne fakty i wynikający z nich własny pomysł „zrobić lepiej”. Tylko dla zespołu Detailly.',
  'marktregister.new': 'Nowa obserwacja',
  'marktregister.empty': 'Brak zapisanych obserwacji.',
  'marktregister.error.load': 'Nie udało się wczytać obserwacji.',
  'marktregister.error.save': 'Nie udało się zapisać działania.',
  'marktregister.action.edit': 'Edytuj',
  'marktregister.filter.status': 'Filtruj wg statusu',
  'marktregister.filter.kategorie': 'Filtruj wg kategorii',
  'marktregister.filter.prioritaet': 'Filtruj wg priorytetu',
  'marktregister.filter.allStatus': 'Wszystkie statusy',
  'marktregister.filter.allKategorie': 'Wszystkie kategorie',
  'marktregister.filter.allPrioritaet': 'Wszystkie priorytety',
  'marktregister.card.observedOn': 'Data obserwacji',
  'marktregister.card.source': 'Źródło',
  'marktregister.field.wettbewerber': 'Konkurent',
  'marktregister.field.kategorie': 'Kategoria',
  'marktregister.field.beobachtung': 'Obserwacja',
  'marktregister.field.beobachtung.help': 'Tylko rzeczowe, publicznie dostępne fakty – bez ocen.',
  'marktregister.field.abgeleiteteIdee': 'Własny pomysł',
  'marktregister.field.abgeleiteteIdee.help': 'Co zrobimy z tym lepiej? Własny pomysł-zadanie.',
  'marktregister.field.quelleUrl': 'Źródło (URL)',
  'marktregister.field.quelleUrl.help': 'Opcjonalnie, tylko http/https.',
  'marktregister.field.beobachtetAm': 'Data obserwacji',
  'marktregister.field.status': 'Status',
  'marktregister.field.prioritaet': 'Priorytet',
  'marktregister.prioritaet.label': 'Priorytet',
  'marktregister.kategorie.preis': 'Cena',
  'marktregister.kategorie.feature': 'Funkcja',
  'marktregister.kategorie.ux': 'Obsługa',
  'marktregister.kategorie.marketing': 'Marketing',
  'marktregister.kategorie.sonstiges': 'Inne',
  'marktregister.status.neu': 'Nowe',
  'marktregister.status.geprueft': 'Sprawdzone',
  'marktregister.status.eingeplant': 'Zaplanowane',
  'marktregister.status.umgesetzt': 'Wdrożone',
  'marktregister.status.verworfen': 'Odrzucone',
  'marktregister.prioritaet.hoch': 'Wysoki',
  'marktregister.prioritaet.mittel': 'Średni',
  'marktregister.prioritaet.niedrig': 'Niski',
  'marktregister.form.newTitle': 'Nowa obserwacja',
  'marktregister.form.editTitle': 'Edytuj obserwację',
  'marktregister.form.neutralHint':
    'Zachowaj neutralność: zapisuj tylko rzeczowe, publicznie dostępne fakty i wyprowadzaj własny pomysł na usprawnienie. Bez oceny konkurenta.',
  'marktregister.form.saving': 'Zapisywanie…',
  'marktregister.toast.created': 'Obserwacja utworzona.',
  'marktregister.toast.saved': 'Zmiany zapisane.',
  'marktregister.toast.statusChanged': 'Status zaktualizowany.',
  'marktregister.toast.deleted': 'Obserwacja usunięta.',
  'marktregister.delete.title': 'Usunąć obserwację?',
  'marktregister.delete.message': 'Ta wewnętrzna notatka zostanie trwale usunięta.',
  'affiliate.title': 'Poleć nas',
  'affiliate.subtitle': 'Poleć Detailly i zdobądź bonusy, gdy polecony warsztat zacznie płacić.',
  'affiliate.error.load': 'Nie udało się załadować danych poleceń.',
  'affiliate.stat.referred': 'Polecone warsztaty',
  'affiliate.stat.paying': 'W tym płacące',
  'affiliate.stat.rewards': 'Naliczone bonusy',
  'affiliate.stat.rewardsHint': 'Rozliczane przy wystawieniu faktury',
  'affiliate.share.title': 'Twój kod polecający',
  'affiliate.share.subtitle': 'Udostępnij kod lub link – nowe warsztaty zostaną przypisane do Ciebie automatycznie.',
  'affiliate.share.codeLabel': 'Kod polecający',
  'affiliate.share.linkLabel': 'Link z zaproszeniem',
  'affiliate.share.help': 'Każdy, kto zarejestruje się przez ten link, liczy się jako Twoje polecenie.',
  'affiliate.copy': 'Kopiuj',
  'affiliate.copied': 'Skopiowano',
  'affiliate.copyLink': 'Kopiuj link',
  'affiliate.reward.notice':
    'Gdy tylko polecony warsztat wykupi płatny abonament, otrzymasz 1 miesiąc Basic jako bonus. Bonus zostanie rozliczony przy następnej fakturze (na razie bez automatycznej płatności).',
  'affiliate.reward.monatBasic': '1 miesiąc Basic',
  'affiliate.list.title': 'Twoje polecenia',
  'affiliate.list.subtitle': 'Tylko Twoje polecone warsztaty.',
  'affiliate.list.empty': 'Brak poleceń – udostępnij link, aby zacząć.',
  'affiliate.list.col.business': 'Warsztat',
  'affiliate.list.col.status': 'Status',
  'affiliate.list.col.reward': 'Bonus',
  'affiliate.list.col.date': 'Data polecenia',
  'affiliate.status.paying': 'Płaci',
  'affiliate.status.registered': 'Zarejestrowany',
  'affiliate.register.label': 'Kod polecający',
  'affiliate.register.placeholder': 'np. ABCD2345',
  'affiliate.register.help': 'Masz kod polecający? Wpisz go tutaj.',

  // ---- Witryna / referencje (przed/po) -------------------------------------
  'schaufenster.title': 'Witryna',
  'schaufenster.subtitle': 'Pokaż publicznie swoje najlepsze efekty przed/po – za zgodą klienta.',
  'schaufenster.upgrade': 'Witryna jest dostępna od planu Basic. Ulepszenie ją odblokowuje.',
  'schaufenster.empty': 'Brak referencji. Dodaj pierwszą referencję przed/po.',
  'schaufenster.new': 'Nowa referencja',
  'schaufenster.count': '{n} referencji · {p} opublikowanych',
  'schaufenster.publicLink.title': 'Publiczny link do witryny',
  'schaufenster.publicLink.hint': 'Udostępnij ten link na stronie lub w mediach społecznościowych. Widoczne są tylko opublikowane referencje.',
  'schaufenster.form.newTitle': 'Dodaj nową referencję',
  'schaufenster.form.editTitle': 'Edytuj referencję',
  'schaufenster.form.titel': 'Tytuł',
  'schaufenster.form.titelPlaceholder': 'np. Mercedes klasy S – pełne oklejenie',
  'schaufenster.form.beschreibung': 'Opis',
  'schaufenster.form.beschreibungPlaceholder': 'Krótko, co zostało zrobione (opcjonalnie)',
  'schaufenster.form.gewerk': 'Usługa',
  'schaufenster.form.vorher': 'Zdjęcie przed',
  'schaufenster.form.nachher': 'Zdjęcie po',
  'schaufenster.form.bildWaehlen': 'Wybierz zdjęcie',
  'schaufenster.form.bildErsetzen': 'Zmień zdjęcie',
  'schaufenster.form.bildHint': 'PNG, JPG lub WebP, do 8 MB. Wskazówka: zamaskuj tablice i rozpoznawalne osoby.',
  'schaufenster.form.save': 'Zapisz',
  'schaufenster.form.saving': 'Zapisywanie …',
  'schaufenster.gewerk.folie': 'Oklejanie',
  'schaufenster.gewerk.aufbereitung': 'Detailing',
  'schaufenster.gewerk.ppf': 'PPF (ochrona lakieru)',
  'schaufenster.status.published': 'Opublikowano',
  'schaufenster.status.draft': 'Szkic',
  'schaufenster.action.publish': 'Opublikuj',
  'schaufenster.action.unpublish': 'Wycofaj',
  'schaufenster.action.edit': 'Edytuj',
  'schaufenster.action.delete': 'Usuń',
  'schaufenster.action.copyLink': 'Kopiuj link',
  'schaufenster.action.copied': 'Skopiowano',
  'schaufenster.action.openPublic': 'Zobacz publicznie',
  'schaufenster.consent.title': 'Zgoda klienta',
  'schaufenster.consent.checkbox': 'Potwierdzam, że posiadam pisemną zgodę klienta na publikację tych zdjęć.',
  'schaufenster.consent.recommendation': 'Zalecenie: w miarę możliwości zamaskuj tablice i rozpoznawalne osoby.',
  'schaufenster.consent.required': 'Najpierw potwierdź zgodę klienta.',
  'schaufenster.consent.confirmedAt': 'Zgoda potwierdzona {datum}',
  'schaufenster.publishDialog.title': 'Opublikuj referencję',
  'schaufenster.publishDialog.text': 'Po opublikowaniu referencja będzie widoczna przez Twój publiczny link do witryny.',
  'schaufenster.delete.title': 'Usuń referencję',
  'schaufenster.delete.text': 'Ta referencja i jej zdjęcia zostaną trwale usunięte. Kontynuować?',
  'schaufenster.preview.before': 'Przed',
  'schaufenster.preview.after': 'Po',
  'schaufenster.slider.aria': 'Porównanie przed/po',
  'schaufenster.slider.handle': 'Przeciągnij suwak – lub przesuń strzałkami',
  'schaufenster.toast.created': 'Referencja dodana',
  'schaufenster.toast.updated': 'Referencja zaktualizowana',
  'schaufenster.toast.published': 'Referencja opublikowana',
  'schaufenster.toast.unpublished': 'Referencja wycofana',
  'schaufenster.toast.deleted': 'Referencja usunięta',
  'schaufenster.toast.copied': 'Link skopiowany',
  'schaufenster.error.load': 'Nie udało się załadować referencji.',
  'schaufenster.error.images': 'Wybierz zdjęcie przed i po.',
  // Publiczna strona witryny
  'schaufenster.public.headline': 'Nasze efekty',
  'schaufenster.public.subtitle': 'Przed i po – przeciągnij suwak, aby zobaczyć różnicę.',
  'schaufenster.public.by': 'Referencje: {betrieb}',
  'schaufenster.public.empty': 'Obecnie nie opublikowano żadnych referencji.',
  'schaufenster.public.loadError': 'Nie udało się załadować strony. Spróbuj ponownie później.',
  'schaufenster.public.notFound': 'Nie znaleziono tej witryny.',
  'schaufenster.public.missingSlug': 'Nie podano warsztatu. Użyj pełnego linku.',
};
