...
export const ru: Partial<Dict> = {
  ...
  'kassenbuch.lock.title': 'Зафиксировать запись?',
  'kassenbuch.lock.message': 'После фиксации запись становится неизменяемой и исправляется только сторнирующей проводкой.',
