...
export const de = {
  ...
  'kassenbuch.lock.title': 'Eintrag festschreiben?',
  'kassenbuch.lock.message': 'Nach dem Festschreiben ist der Eintrag unveränderlich und kann nur noch per Storno-Gegenbuchung korrigiert werden.',
