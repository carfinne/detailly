...
export const de = {
  ...
  'geraetemarkt.subtitle': 'Gebrauchte Geräte und Ausrüstung von verifizierten Betrieben – kaufen und anbieten.',
  ...
  'geraetemarkt.form.chemieTitle': 'Nur Geräte & Ausrüstung — KEINE Chemie oder Verbrauchsstoffe',
  'geraetemarkt.form.chemieHint': 'Poliermittel, Versiegelungen, Reiniger und andere Verbrauchs-/Gefahrstoffe sind auf dem Gebrauchtmarkt nicht erlaubt.',
  ...
  'geraetemarkt.form.confirm': 'Ich biete als Gewerbetreibender an, meine Angaben sind korrekt und ich verkaufe ausschließlich Geräte/Ausrüstung (keine Chemie/Verbrauchsstoffe).',
