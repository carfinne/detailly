...
export const de = {
  ...
  'nav.item.dellenkalkulation': 'Dellenkalkulation (PDR)',
  ...
  'nav.item.showcase': 'Schaufenster',
  ...
  'nav.item.platformGeraetemarkt': 'Gebrauchtmarkt-Moderation',
  'nav.item.platformSupport': 'Support-Anfragen',
  'nav.item.platformSecurity': 'Sicherheit',
  ...
  'settings.buchung.modusTitle': 'Abschluss der Buchungsseite',
  'settings.buchung.modusSubtitle': 'Legt fest, ob deine öffentliche Buchungsseite eine unverbindliche Anfrage oder eine verbindliche, zahlungspflichtige Buchung ist.',
  'settings.buchung.modusLabel': 'Modus',
  'settings.buchung.modusAnfrage': 'Unverbindliche Terminanfrage',
  'settings.buchung.modusVerbindlich': 'Verbindliche, zahlungspflichtige Buchung',
  'settings.buchung.modusHelp': 'Anfrage: Kundinnen und Kunden senden eine unverbindliche Anfrage – es kommt noch kein Vertrag zustande, du bestätigst den Termin. Verbindlich: Es wird online ein kostenpflichtiger Vertrag geschlossen (Button „Zahlungspflichtig buchen“, Widerrufsrecht).',
  'settings.buchung.modusVerbindlichHint': 'Im verbindlichen Modus schließen Kundinnen und Kunden online einen kostenpflichtigen Fernabsatzvertrag mit dir. Prüfe Preisangaben, Impressum und Widerrufsbelehrung sorgfältig – die Verantwortung liegt bei dir.',
  'settings.buchung.impressumIncomplete': 'Buchungsseite unvollständig: Impressumsangaben fehlen. Kundinnen und Kunden sehen den Anbieter (Vertragspartner) nur teilweise. Bitte im Impressum-Abschnitt unten ergänzen.',
  ...
  'buchen.recht.badge.anfrage': 'Online-Terminanfrage',
  'buchen.recht.badge.verbindlich': 'Online-Buchung',
  'buchen.recht.anbieter.title': 'Anbieter',
  'buchen.recht.anbieter.hint': 'Vertragspartner ist der oben genannte Betrieb, nicht Detailly.',
  'buchen.recht.pflichtinfo.title': 'Ihre Buchung im Überblick',
  'buchen.recht.pflichtinfo.leistung': 'Leistung',
  'buchen.recht.pflichtinfo.keineLeistung': 'Keine Leistung gewählt',
  'buchen.recht.pflichtinfo.preis': 'Preis',
  'buchen.recht.pflichtinfo.termin': 'Termin',
  'buchen.recht.pflichtinfo.keinTermin': 'Kein Termin gewählt',
  'buchen.recht.pflichtinfo.checkbox': 'Ich habe die Pflichtinformationen und die Widerrufsbelehrung gelesen.',
  'buchen.recht.pflichtinfo.checkboxError': 'Bitte bestätigen Sie die Pflichtinformationen und die Widerrufsbelehrung.',
  'buchen.recht.widerruf.title': 'Widerrufsrecht',
  'buchen.recht.widerruf.deHint': 'Der amtliche Rechtstext ist nur auf Deutsch verfügbar.',
  'buchen.recht.widerruf.belehrungLabel': 'Widerrufsbelehrung anzeigen',
  'buchen.recht.widerruf.formularLabel': 'Muster-Widerrufsformular anzeigen',
  'buchen.recht.vorzeitig.checkbox': 'Ich verlange ausdrücklich, dass der Betrieb vor Ablauf der 14-tägigen Widerrufsfrist mit der Ausführung beginnt. Mir ist bekannt, dass ich mit vollständiger Vertragserfüllung mein Widerrufsrecht verliere.',
  'buchen.recht.vorzeitig.error': 'Bitte stimmen Sie dem vorzeitigen Leistungsbeginn zu oder wählen Sie einen späteren Termin.',
  'buchen.recht.datenschutz.hintAnfrage': 'Ihre Angaben verarbeitet der Betrieb zur Bearbeitung Ihrer Terminanfrage. Verantwortlich ist der oben genannte Anbieter.',
  'buchen.recht.datenschutz.hintVerbindlich': 'Ihre Angaben verarbeitet der Betrieb zur Abwicklung des Vertrags. Verantwortlich ist der oben genannte Anbieter.',
  'buchen.recht.datenschutz.link': 'Datenschutzhinweise',
  'buchen.recht.datenschutz.checkbox': 'Ich habe die Datenschutzhinweise zur Kenntnis genommen.',
  'buchen.recht.verbindlich.emailRequired': 'Für eine verbindliche, zahlungspflichtige Buchung benötigen wir Ihre E-Mail-Adresse – dorthin senden wir die Buchungsbestätigung und die Widerrufsbelehrung.',
  'buchen.recht.verbindlich.leistungRequired': 'Bitte wählen Sie für eine verbindliche Buchung eine Leistung aus.',
  'buchen.recht.anfrage.hinweis': 'Es kommt noch kein Vertrag zustande; der Betrieb bestätigt Ihren Termin.',
  'buchen.recht.anfrage.button': 'Unverbindlich anfragen',
  'buchen.recht.anfrage.submitting': 'Wird gesendet…',
  'buchen.recht.verbindlich.intro': 'Mit dem Klick schließen Sie einen kostenpflichtigen Vertrag mit dem Betrieb.',
  'buchen.recht.verbindlich.button': 'Zahlungspflichtig buchen',
  'buchen.recht.verbindlich.submitting': 'Buchung läuft…',
  'buchen.recht.success.anfrage.title': 'Anfrage gesendet',
  'buchen.recht.success.anfrage.text': 'Vielen Dank! {betrieb} meldet sich bei Ihnen, um den Termin zu bestätigen.',
  'buchen.recht.success.verbindlich.title': 'Buchung bestätigt',
  'buchen.recht.success.verbindlich.text': 'Vielen Dank für Ihre zahlungspflichtige Buchung bei {betrieb}. Die Bestätigung mit Widerrufsbelehrung erhalten Sie per E-Mail.',
  'buchen.recht.success.reference': 'Ihre Referenz:',
  ...
  'settings.bereich.navLabel': 'Bereiche der Betriebseinstellungen',
  'settings.bereich.stammdaten': 'Stammdaten & Marke',
  'settings.bereich.steuer': 'Steuer & Impressum',
  'settings.bereich.rechnung': 'Bank & Rechnung',
  'settings.bereich.kalender': 'Kalkulation & Kalender',
  'settings.bereich.email': 'E-Mail-Versand',
  'settings.bereich.mahnwesen': 'Mahnwesen',
  'settings.bereich.buchhaltung': 'DATEV & sevDesk',
  'settings.bereich.sicherheit': 'Sicherheit',

  // Einstellungen: Status-Mail-Vorlagen (editierbar, je Status Betreff + Text)
  'settings.statusmail.title': 'Status-Mail-Vorlagen',
  'settings.statusmail.subtitle': 'Passen Sie Betreff und Text der automatischen Status-Mails an Ihre Kunden an.',
  'settings.statusmail.reviewNote': 'Der Versand-Auslöser bleibt unverändert: Status-Mails gehen nur, wenn der Status-Schalter (Kundenkommunikation) an ist. Hier passen Sie ausschließlich den Text an.',
  'settings.statusmail.placeholders': 'Verfügbare Platzhalter:',
  'settings.statusmail.status.bestaetigt': 'Auftrag bestätigt',
  'settings.statusmail.status.in_arbeit': 'Auftrag in Arbeit',
  'settings.statusmail.status.abholbereit': 'Fahrzeug abholbereit',
  'settings.statusmail.reset': 'Auf Standard zurücksetzen',
  'settings.statusmail.subject': 'Betreff',
  'settings.statusmail.subjectPlaceholder': 'Leer lassen für den Standard-Betreff',
  'settings.statusmail.body': 'Text',
  'settings.statusmail.bodyPlaceholder': 'Leer lassen für den Standard-Text',
  'settings.statusmail.defaultHint': 'Leer = es wird der bewährte Standard-Text verwendet.',
  'settings.statusmail.footerHint': 'Anrede, Link zum Auftragsstatus und Grußformel werden automatisch ergänzt – Ihr Text steht dazwischen.',

  // Einstellungen: Benachrichtigungs-Präferenzen je Nutzer (Glocke)
  'settings.benachrichtigungen.title': 'Benachrichtigungen',
  'settings.benachrichtigungen.subtitle': 'Welche Hinweise in Ihrer Glocke erscheinen sollen.',
  'settings.benachrichtigungen.intro': 'Diese Einstellung gilt nur für Sie. Standardmäßig sind alle Hinweise aktiv.',
  'settings.benachrichtigungen.rechnungenFaellig': 'Überfällige Rechnungen',
  'settings.benachrichtigungen.rechnungenFaelligHint': 'Hinweis, wenn Rechnungen ihr Zahlungsziel überschritten haben.',
  'settings.benachrichtigungen.termineHeute': 'Termine heute',
  ...
  'settings.benachrichtigungen.auslastungHint': 'Hinweis, wenn die Wochen-Auslastung unter Ihrem Ziel liegt.',
  'settings.benachrichtigungen.par19': '§ 19-Umsatzgrenze',
  'settings.benachrichtigungen.par19Hint': 'Warnung, wenn Sie sich der Kleinunternehmer-Umsatzgrenze nähern.',
  ...
  'dashboard.briefing.title': 'Tagesbriefing',
  'dashboard.briefing.utilization': 'Auslastung diese Woche: {prozent} %',
  'dashboard.briefing.appointmentsToday': 'Termine heute: {count}',
  'dashboard.briefing.openInvoices': 'Offene Rechnungen: {count}',
  'dashboard.briefing.allClear': 'Alles erledigt – keine offenen Hinweise.',
  ...
  'marktplatz.sort.recommended': 'Empfohlen',
  'marktplatz.sort.rating': 'Beste Bewertung',
  'marktplatz.view.grid': 'Rasteransicht',
  'marktplatz.view.list': 'Listenansicht',
  'marktplatz.filter.label': 'Filter',
  'marktplatz.filter.brand': 'Hersteller',
  'marktplatz.filter.price': 'Preis (€)',
  'marktplatz.filter.priceMin': 'von',
  'marktplatz.filter.priceMax': 'bis',
  'marktplatz.filter.availability': 'Verfügbarkeit',
  'marktplatz.filter.availAll': 'Alle',
  'marktplatz.filter.more': 'Weitere Filter',
  'marktplatz.filter.orderableOnly': 'Nur bestellbar',
  'marktplatz.filter.withSdb': 'Mit Sicherheitsdatenblatt',
  'marktplatz.filter.origin': 'Herkunftsland',
  'marktplatz.category.all': 'Alle Unterkategorien',
  'marktplatz.bestand.verfuegbar': 'Verfügbar',
  'marktplatz.bestand.wenig': 'Nur noch wenige',
  'marktplatz.bestand.ausverkauft': 'Ausverkauft',
  'marktplatz.badge.sdb': 'SDB',
  'marktplatz.highlight': 'Empfehlung',
  'marktplatz.highlightsTitle': 'Empfohlen für dich',
  'marktplatz.quickView': 'Schnellansicht',
  'marktplatz.quickView.details': 'Alle Details ansehen',
  'marktplatz.rating.aria': '{schnitt} von 5 Sternen ({anzahl} Bewertungen)',
  'marktplatz.rating.stars': '{n} von 5 Sternen',
  'marktplatz.detail.back': 'Zurück zum Marktplatz',
  'marktplatz.detail.missingId': 'Kein Produkt ausgewählt.',
  'marktplatz.detail.notFound': 'Produkt nicht gefunden oder nicht mehr verfügbar.',
  'marktplatz.detail.error': 'Produkt konnte nicht geladen werden.',
  'marktplatz.detail.showImage': 'Bild {n} anzeigen',
  'marktplatz.detail.description': 'Beschreibung',
  'marktplatz.detail.usage': 'Anwendungshinweise',
  'marktplatz.detail.techData': 'Technische Daten',
  'marktplatz.detail.reviews': 'Bewertungen',
  'marktplatz.detail.noReviews': 'Noch keine Bewertungen.',
  'marktplatz.detail.verifiedPurchase': 'Verifizierter Kauf',
  'marktplatz.detail.related': 'Ähnliche Produkte',
  'marktplatz.detail.sdbDownload': 'Sicherheitsdatenblatt (PDF)',
  'marktplatz.detail.sdbPending': 'Für diese Kategorie ist ein Sicherheitsdatenblatt vorgesehen – der Händler reicht es in Kürze nach.',
  'marktplatz.detail.sdbError': 'Sicherheitsdatenblatt konnte nicht geladen werden.',
  'marktplatz.detail.shipping': 'Versand',
  'marktplatz.detail.freeShipping': 'Kostenlos',
  'marktplatz.detail.deliveryTime': 'Lieferzeit',
  ...
  'dellen.title': 'Dellenkalkulation',
  'dellen.subtitle':
    'Smart Repair / PDR: Delle im 3D-Modell anklicken – Sofortpreis nach Größe, Kante, Alu und Lackschaden.',
  'dellen.upgrade':
    'Die Dellenkalkulation ist ab dem Basic-Tarif enthalten. Jetzt upgraden, um Park- und Hageldellen sofort zu bepreisen.',
  'dellen.new': 'Neue Kalkulation',
  'dellen.none': 'Noch keine Dellenkalkulation. Legen Sie die erste an.',
  'dellen.deleted': 'Kalkulation gelöscht.',
  'dellen.finalized': 'Kalkulation finalisiert.',
  'dellen.finalize': 'Finalisieren',
  'dellen.locked': 'Die Kalkulation ist finalisiert und nicht mehr änderbar.',
  'dellen.fallback': 'WebGL nicht verfügbar – 2D-Schema als Fallback.',
  'dellen.status.final': 'Finalisiert',
  'dellen.error.load': 'Kalkulation konnte nicht geladen werden.',
  'dellen.error.save': 'Speichern fehlgeschlagen.',
  'dellen.modal.title': 'Neue Dellenkalkulation',
  'dellen.modal.modus': 'Modus',
  'dellen.modal.customer': 'Kunde',
  'dellen.modal.vehicle': 'Fahrzeug',
  'dellen.modal.notiz': 'Notiz',
  'dellen.modal.optional': 'Optional',
  'dellen.modal.creating': 'Wird angelegt…',
  'dellen.modal.create': 'Anlegen',
  'dellen.modus.einzel': 'Einzeldellen',
  'dellen.modus.hagel': 'Hagel',
  'dellen.modus.einzel.hint': 'Parkschaden: jede Delle einzeln mit Größe und Merkmalen erfassen.',
  'dellen.modus.hagel.hint':
    'Hagel: je Bauteil die Anzahl der Dellen zählen – Preis nach Staffel (Panel-Pauschale).',
  'dellen.groesse.title': 'Größenklasse',
  'dellen.groesse.1euro': '1-Euro',
  'dellen.groesse.2euro': '2-Euro',
  'dellen.groesse.5euro': '5-Euro',
  'dellen.groesse.golfball': 'Golfball',
  'dellen.groesse.groesser': 'Größer',
  'dellen.flag.kante': 'Kante/Sicke',
  'dellen.flag.alu': 'Aluminium',
  'dellen.flag.lackschaden': 'Lackschaden',
  'dellen.hagel.count': 'Anzahl Dellen an diesem Bauteil',
  'dellen.hagel.countShort': '{n} Dellen',
  'dellen.marker.price': 'Einzelpreis',
  'dellen.marker.remove': 'Marker entfernen',
  'dellen.marker.list': 'Erfasste Dellen',
  'dellen.marker.empty': 'Klicken Sie ein Bauteil an, um eine Delle zu setzen.',
  'dellen.sum.title': 'Gesamtpreis',
  'dellen.sum.count': '{n} Marker',
  'dellen.hint.title': 'Hinweis',
  'dellen.hint.text':
    'Regelbasierter Richtpreis nach Ihrer Preismatrix – kein verbindliches Angebot. Endpreis erst nach Sichtprüfung.',
  'dellen.hint.einzel': 'Bauteil anklicken setzt eine einzelne Delle.',
  'dellen.hint.hagel': 'Bauteil anklicken zählt die Dellen dieses Bauteils (Panel-Staffel).',
  'dellen.matrix.title': 'Preismatrix',
  'dellen.matrix.open': 'Preise einstellen',
  'dellen.matrix.saved': 'Preismatrix gespeichert.',
  'dellen.matrix.basispreise': 'Basispreise je Größenklasse (€)',
  'dellen.matrix.kantenFaktor': 'Faktor Kante/Sicke',
  'dellen.matrix.aluFaktor': 'Faktor Aluminium',
  'dellen.matrix.lackschadenAufschlag': 'Lackschaden-Aufschlag (€)',
  'dellen.matrix.mindestpauschale': 'Mindestpauschale (€)',
  'dellen.matrix.anfahrtspauschale': 'Anfahrtspauschale (€)',
  'dellen.matrix.hagelStaffel': 'Hagel-Staffel (Panel-Pauschale je Dellen-Anzahl)',
  'dellen.matrix.staffelMore': 'darüber',
  'dellen.matrix.staffelUpTo': 'bis {n}',
  'dellen.confirmDelete.title': 'Kalkulation löschen?',
  'dellen.confirmDelete.message': 'Die Kalkulation und alle Marker werden dauerhaft gelöscht.',
  'dellen.confirmFinal.title': 'Kalkulation finalisieren?',
  'dellen.confirmFinal.message':
    'Nach dem Finalisieren ist die Kalkulation gesperrt und nicht mehr änderbar.',
  ...
  'fahrzeugannahme.kennzeichen.neu.subtitle':
    'Noch nicht angelegt? Kunde und Fahrzeug direkt hier erfassen – nur das Nötigste, der Rest folgt später.',
  'fahrzeugannahme.kennzeichen.neu.name': 'Kundenname',
  'fahrzeugannahme.kennzeichen.neu.namePlaceholder': 'z. B. Max Mustermann',
  'fahrzeugannahme.kennzeichen.neu.telefon': 'Telefon',
  'fahrzeugannahme.kennzeichen.neu.telefonPlaceholder': 'z. B. 0151 23456789',
  'fahrzeugannahme.kennzeichen.neu.mehr': 'Weitere Angaben (optional)',
  'fahrzeugannahme.kennzeichen.neu.marke': 'Marke',
  'fahrzeugannahme.kennzeichen.neu.modell': 'Modell',
  'fahrzeugannahme.kennzeichen.neu.farbe': 'Farbe',
  'fahrzeugannahme.kennzeichen.neu.baujahr': 'Baujahr',
  'fahrzeugannahme.kennzeichen.neu.submit': 'Anlegen & übernehmen',
  ...
  'datenpanne.noAccess': 'Nur Inhaber/Admin dürfen das Datenpannen-Register einsehen.',
  'datenpanne.new': 'Neuer Vorfall',
  'datenpanne.empty': 'Noch keine Vorfälle erfasst.',
  'datenpanne.error.load': 'Die Vorfälle konnten nicht geladen werden.',
  ...
  'datenpanne.frist.deadline': 'Frist: {datum}',
  'datenpanne.field.status': 'Status',
  'datenpanne.field.schweregrad': 'Schweregrad',
  'datenpanne.field.kenntnis': 'Kenntnis',
  'datenpanne.field.beschreibung': 'Beschreibung des Vorfalls',
  'datenpanne.field.personen': 'Betroffene Personen (ca.)',
  'datenpanne.field.datensaetze': 'Betroffene Datensätze (ca.)',
  'datenpanne.field.kategorien': 'Betroffene Datenkategorien',
  'datenpanne.field.kategorienHint': 'Kommagetrennt, z. B. Kontaktdaten, Fahrzeugdaten',
  'datenpanne.field.folgen': 'Wahrscheinliche Folgen',
  'datenpanne.field.massnahmen': 'Getroffene Maßnahmen',
  'datenpanne.field.risiko': 'Risikobewertung',
  'datenpanne.section.sachverhalt': 'Sachverhalt',
  'datenpanne.save': 'Änderungen speichern',
  'datenpanne.status.erkannt': 'Erkannt',
  'datenpanne.status.in_pruefung': 'In Prüfung',
  'datenpanne.status.meldepflichtig': 'Meldepflichtig',
  'datenpanne.status.gemeldet': 'Gemeldet',
  'datenpanne.status.nicht_meldepflichtig': 'Nicht meldepflichtig',
  'datenpanne.status.abgeschlossen': 'Abgeschlossen',
  'datenpanne.schwere.niedrig': 'Niedrig',
  'datenpanne.schwere.mittel': 'Mittel',
  'datenpanne.schwere.hoch': 'Hoch',
  'datenpanne.schwere.kritisch': 'Kritisch',
  'datenpanne.quelle.auto_signal': 'Automatisch erkannt',
  'datenpanne.quelle.manuell': 'Manuell erfasst',
  'datenpanne.quelle.extern_gemeldet': 'Extern gemeldet',
  'datenpanne.quelle.kunde_gemeldet': 'Von Kunde gemeldet',
  'datenpanne.signal.export_spike': 'Auffällig viele Datenexporte',
  'datenpanne.signal.login_bruteforce': 'Gehäufte fehlgeschlagene Anmeldungen',
  'datenpanne.signal.forbidden_spike': 'Gehäufte unberechtigte Zugriffe',
  'datenpanne.eskalation.title': 'Melde- & Eskalationskette',
  'datenpanne.eskalation.hint':
    'Nichts wird automatisch verschickt – hier nur dokumentieren, dass/wann gemeldet wurde.',
  'datenpanne.eskalation.verantwortlicher': 'Verantwortlichen (Betrieb) informiert (Art. 33 Abs. 2)',
  'datenpanne.eskalation.behoerde': 'Aufsichtsbehörde gemeldet (Art. 33)',
  'datenpanne.eskalation.betroffene': 'Betroffene Personen benachrichtigt (Art. 34)',
  'datenpanne.meldung.title': 'Melde-Vorlage (Art. 33)',
  'datenpanne.meldung.hint':
    'Textvorlage zum Prüfen und selbst Versenden – Detailly verschickt nichts automatisch.',
  'datenpanne.meldung.generate': 'Vorlage erzeugen',
  'datenpanne.meldung.copy': 'Text kopieren',
  'datenpanne.meldung.copied': 'In die Zwischenablage kopiert.',
  'datenpanne.meldung.empty': 'Noch keine Vorlage erzeugt.',
  'datenpanne.create.title': 'Vorfall erfassen',
  'datenpanne.create.hint':
    'Die 72-Stunden-Frist läuft ab dem Kenntniszeitpunkt (wird auf jetzt gesetzt).',
  'datenpanne.create.submit': 'Vorfall anlegen',
  'datenpanne.create.saved': 'Vorfall angelegt.',
  'datenpanne.create.beschreibungRequired': 'Bitte den Vorfall kurz beschreiben.',

  // --- Sentinel Teil 2: Betreiber-Sicht „Sicherheit" ---
  'platformSecurity.title': 'Sicherheit',
  'platformSecurity.subtitle': 'Sentinel – Anwendungs-Level-Abwehr über alle Betriebe.',
  'platformSecurity.error.load': 'Sicherheitsdaten konnten nicht geladen werden.',
  'platformSecurity.tile.failLogins': 'Fehl-Logins (24 h)',
  'platformSecurity.tile.scans': '4xx-Scans (24 h)',
  'platformSecurity.tile.autoBlocks': 'Auto-Sperren (24 h)',
  'platformSecurity.tile.activeBlocks': 'Aktive Sperren',
  'platformSecurity.topIps.title': 'Auffällige IPs',
  'platformSecurity.topIps.subtitle': 'Meiste Ereignisse (24 h)',
  'platformSecurity.topIps.empty': 'Keine Ereignisse in den letzten 24 Stunden.',
  'platformSecurity.blocks.title': 'IP-Sperren',
  'platformSecurity.blocks.subtitle': 'Aktuell aktive Sperren',
  'platformSecurity.blocks.add': 'IP sperren',
  'platformSecurity.blocks.empty': 'Keine aktiven Sperren.',
  'platformSecurity.blocks.until': 'bis',
  'platformSecurity.blocks.permanent': 'dauerhaft',
  'platformSecurity.blocks.system': 'automatisch',
  'platformSecurity.blocks.manual': 'manuell',
  'platformSecurity.blocks.unblock': 'Entsperren',
  'platformSecurity.blocks.unblockConfirmTitle': 'IP entsperren?',
  'platformSecurity.blocks.unblockConfirmMsg': 'Die Sperre für {ip} wird sofort aufgehoben.',
  'platformSecurity.events.title': 'Sicherheits-Ereignisse',
  'platformSecurity.events.count': 'Ereignisse gesamt',
  'platformSecurity.events.empty': 'Keine Ereignisse für diesen Filter.',
  'platformSecurity.events.filter.allTypes': 'Alle Typen',
  'platformSecurity.events.filter.allSeverities': 'Alle Schweregrade',
  'platformSecurity.events.filter.ip': 'IP filtern…',
  'platformSecurity.events.col.time': 'Zeit',
  'platformSecurity.events.col.type': 'Typ',
  'platformSecurity.events.col.severity': 'Schweregrad',
  'platformSecurity.events.col.ip': 'IP',
  'platformSecurity.readonly':
    'Nur-Lesen (Analyst/Support): IP-Sperren setzen/aufheben ist Platform-Admin vorbehalten.',
  'platformSecurity.block.modalTitle': 'IP manuell sperren',
  'platformSecurity.block.ip': 'IP-Adresse',
  'platformSecurity.block.reason': 'Grund',
  'platformSecurity.block.duration': 'Dauer (Minuten)',
  'platformSecurity.block.durationHint': 'Leer = 30 Tage (für unbefristet unten „Dauerhaft" wählen)',
  'platformSecurity.block.permanent': 'Dauerhaft sperren (kein Ablauf)',
  'platformSecurity.block.ipInvalid': 'Bitte eine gültige IP-Adresse eingeben.',
  'platformSecurity.block.severity': 'Schweregrad',
  'platformSecurity.block.submit': 'Sperren',
  'platformSecurity.block.success': 'IP gesperrt.',
  'platformSecurity.block.error': 'Aktion fehlgeschlagen.',
  'platformSecurity.unblock.success': 'Sperre aufgehoben.',
  'platformSecurity.eventType.login_fail': 'Fehl-Login',
  'platformSecurity.eventType.login_lockout': 'Login-Sperre',
  'platformSecurity.eventType.mfa_fail': '2FA-Fehler',
  'platformSecurity.eventType.scan_4xx': '4xx-Scan',
  'platformSecurity.eventType.ip_block': 'IP-Sperre',
  'platformSecurity.eventType.ip_unblock': 'IP-Entsperrung',
  ...
  // ---------------------------------------------------------------------------
  'cockpit.title': 'Betreiber-Cockpit',
  'cockpit.subtitle': 'Detailly-Plattform – Live-Kennzahlen, Standorte und Betriebe.',
  'cockpit.error.load': 'Die Cockpit-Daten konnten nicht geladen werden.',
  'cockpit.common.yes': 'Ja',

  'cockpit.tab.uebersicht': 'Übersicht',
  'cockpit.tab.standorte': 'Standorte',
  'cockpit.tab.betriebe': 'Betriebe',
  'cockpit.tab.protokoll': 'Protokoll',

  // Übersicht
  'cockpit.live.title': 'Live-Kennzahlen',
  'cockpit.live.subtitle': 'Echtzeit über alle Betriebe der Plattform.',
  'cockpit.kpi.tenants': 'Betriebe gesamt',
  'cockpit.kpi.trials': 'Testphasen enden',
  'cockpit.kpi.trialsHint': 'in den nächsten 7 Tagen',
  'cockpit.kpi.activeUsers': 'Aktive Nutzer (24 h)',
  'cockpit.kpi.tickets': 'Offene Tickets',
  'cockpit.hub.title': 'Schnellzugriff',
  'cockpit.hub.subtitle': 'Spezialbereiche der Plattform.',
  'cockpit.hub.open': 'Öffnen',
  'cockpit.hub.support': 'Support',
  'cockpit.hub.supportHint': 'Anfragen aller Betriebe beantworten',
  'cockpit.hub.marketplace': 'Marktplatz',
  'cockpit.hub.marketplaceHint': 'Händler-Bewerbungen prüfen & pflegen',
  'cockpit.hub.newsletter': 'Newsletter',
  'cockpit.hub.newsletterHint': 'Produkt-News an alle Betriebe senden',

  // Standorte
  'cockpit.loc.empty': 'Noch keine Standortdaten vorhanden.',
  'cockpit.loc.total': 'Betriebe mit Standort',
  'cockpit.loc.regions': 'Leitregionen',
  'cockpit.loc.region': 'PLZ {region}',
  'cockpit.zone.0': 'Sachsen · Sachsen-Anhalt · Thüringen',
  'cockpit.zone.1': 'Berlin · Brandenburg · Meck-Pomm',
  'cockpit.zone.2': 'Hamburg · Schleswig-Holstein · Bremen',
  'cockpit.zone.3': 'Niedersachsen (Süd) · Nordhessen · OWL',
  'cockpit.zone.4': 'NRW West · Ruhrgebiet · Münsterland',
  'cockpit.zone.5': 'Köln · Bonn · Aachen · Rheinland',
  'cockpit.zone.6': 'Rhein-Main · Rheinland-Pfalz · Saarland',
  'cockpit.zone.7': 'Baden-Württemberg',
  'cockpit.zone.8': 'München · Südbayern',
  'cockpit.zone.9': 'Nürnberg · Nordbayern',

  // Betriebe (Liste + Detail)
  'cockpit.tenants.searchPlaceholder': 'Betrieb suchen (Name, Ort, E-Mail)…',
  'cockpit.tenants.filter.alle': 'Alle',
  'cockpit.tenants.empty': 'Noch keine Betriebe vorhanden.',
  'cockpit.tenants.emptyFiltered': 'Keine Betriebe für diese Suche.',
  'cockpit.tenants.col.name': 'Betrieb',
  'cockpit.tenants.col.typ': 'Typ',
  'cockpit.tenants.col.status': 'Status',
  'cockpit.tenants.col.nutzer': 'Nutzer',
  'cockpit.tenants.col.abo': 'Abo',
  'cockpit.tenantStatus.active': 'Aktiv',
  'cockpit.tenantStatus.trial': 'Testphase',
  'cockpit.tenantStatus.inactive': 'Inaktiv',
  'cockpit.detail.title': 'Betrieb',
  'cockpit.detail.loadError': 'Der Betriebs-Datensatz konnte nicht geladen werden.',
  'cockpit.detail.profil': 'Profil',
  'cockpit.detail.slug': 'Kürzel',
  'cockpit.detail.address': 'Anschrift',
  'cockpit.detail.created': 'Registriert',
  'cockpit.detail.nutzung': 'Nutzung',
  'cockpit.detail.auftraege': 'Aufträge',
  'cockpit.detail.belege': 'Belege',
  'cockpit.detail.abo': 'Abo',
  'cockpit.detail.toAbos': 'Zur Abo-Verwaltung',
  'cockpit.detail.tarif': 'Tarif',
  'cockpit.detail.price': 'Preis / Monat',
  'cockpit.detail.trialEnds': 'Testphase endet',
  'cockpit.detail.periodEnd': 'Laufzeit bis',
  'cockpit.detail.cancelAtPeriodEnd': 'Kündigt zum Laufzeitende',
  'cockpit.detail.canceled': 'Gekündigt am',
  'cockpit.detail.note': 'Notiz',
  'cockpit.detail.readonlyHint': 'Nur-Lesen. Die Abo-Verwaltung erfolgt unter „Abos".',
  'cockpit.detail.nutzer': 'Nutzer',
  'cockpit.detail.noUsers': 'Keine Nutzer hinterlegt.',
  'cockpit.detail.noAbo': 'Kein Abo',
  'cockpit.detail.inactive': 'inaktiv',

  // Nutzer-Lookup (nur Plattform-Admin)
  'cockpit.lookup.title': 'Nutzer per E-Mail finden',
  'cockpit.lookup.subtitle': 'Betriebsübergreifende Suche (nur Plattform-Admin).',
  'cockpit.lookup.placeholder': 'E-Mail-Adresse (mind. 3 Zeichen)…',
  ...
  'cockpit.audit.subtitle': 'Plattformweite Lesesicht (nur Plattform-Admin).',
  'cockpit.audit.filter.action': 'Aktion filtern…',
  'cockpit.audit.filter.tenant': 'Betriebs-ID filtern…',
  'cockpit.audit.empty': 'Noch keine Protokoll-Einträge.',
  'cockpit.audit.emptyFiltered': 'Keine Einträge für diesen Filter.',
  'cockpit.audit.col.zeit': 'Zeit',
  'cockpit.audit.col.aktion': 'Aktion',
  'cockpit.audit.col.objekt': 'Objekt',
  'cockpit.audit.col.betrieb': 'Betrieb',
  'cockpit.audit.col.nutzer': 'Nutzer',
  // ---- Händler-Portal (angemeldet, Marktplatz-Ausbau PR8) ------------------
  'haendlerportal.eyebrow': 'Detailly · Händler-Portal',
  'haendlerportal.provision': 'Provision an Detailly: {satz} % je Bestellung',
  'haendlerportal.logout': 'Abmelden',
  'haendlerportal.guard.checking': 'Zugang wird geprüft…',
  'haendlerportal.loading': 'Portal wird geladen…',
  'haendlerportal.error.noAccess': 'Dieses Konto hat keinen Händler-Zugang.',
  'haendlerportal.error.load': 'Das Portal konnte nicht geladen werden. Bitte später erneut versuchen.',
  'haendlerportal.tab.overview': 'Übersicht',
  'haendlerportal.tab.products': 'Produkte ({n})',
  'haendlerportal.tab.orders': 'Bestellungen',
  'haendlerportal.tab.ordersNew': 'Bestellungen ({n} neu)',
  'haendlerportal.kpi.products': 'Produkte',
  'haendlerportal.kpi.productsActive': '{n} aktiv',
  'haendlerportal.kpi.ordersOpen': 'Offene Bestellungen',
  'haendlerportal.kpi.ordersTotal': 'Bestellungen gesamt',
  'haendlerportal.overview.recentOrders': 'Letzte Bestellungen',
  'haendlerportal.overview.allOrders': 'Alle ansehen',
  'haendlerportal.orders.empty': 'Noch keine Bestellungen eingegangen.',
  'haendlerportal.orders.confirm': 'Bestätigen',
  'haendlerportal.orders.cancel': 'Stornieren',
  'haendlerportal.orders.ship': 'Als versendet markieren',
  'haendlerportal.orders.statusSaved': 'Status aktualisiert.',
  'haendlerportal.orders.statusError': 'Status konnte nicht geändert werden.',
  'haendlerportal.status.eingegangen': 'Eingegangen',
  'haendlerportal.status.bestaetigt': 'Bestätigt',
  'haendlerportal.status.versendet': 'Versendet',
  'haendlerportal.status.storniert': 'Storniert',
  'haendlerportal.products.new': '+ Neues Produkt einstellen',
  'haendlerportal.products.editTitle': 'Produkt bearbeiten',
  'haendlerportal.products.newTitle': 'Neues Produkt',
  'haendlerportal.products.saved': 'Produkt gespeichert.',
  'haendlerportal.products.saveError': 'Speichern fehlgeschlagen.',
  'haendlerportal.products.saving': 'Speichert…',
  'haendlerportal.products.empty': 'Noch keine Produkte eingestellt.',
  'haendlerportal.products.edit': 'Bearbeiten',
  'haendlerportal.products.activate': 'Aktivieren',
  'haendlerportal.products.deactivate': 'Deaktivieren',
  'haendlerportal.products.activated': 'Produkt aktiviert.',
  'haendlerportal.products.deactivated': 'Produkt deaktiviert.',
  'haendlerportal.products.inactive': 'inaktiv',
  'haendlerportal.products.orderable': 'bestellbar',
  'haendlerportal.products.footerHint':
    'Änderungen erscheinen sofort im Detailly-Marktplatz. Bestellbare Produkte brauchen einen festen Preis, alle anderen einen Shop-/Affiliate-Link.',
  'haendlerportal.field.name': 'Name',
  'haendlerportal.field.bereich': 'Bereich',
  'haendlerportal.field.marke': 'Marke (z. B. 3M, Koch Chemie)',
  'haendlerportal.field.kategorie': 'Produktgruppe (frei)',
  'haendlerportal.field.preis': 'Preis (EUR)',
  'haendlerportal.field.preisHinweis': 'Preis-Zusatz (z. B. „pro Rolle“)',
  'haendlerportal.field.bildUrl': 'Bild-URL (https)',
  'haendlerportal.field.affiliateUrl': 'Externer Shop-/Affiliate-Link (optional)',
  'haendlerportal.field.beschreibung': 'Beschreibung',
  'haendlerportal.field.bestellbar': 'Direkt über Detailly bestellbar (fester Preis nötig)',
  'haendlerportal.uploads.saveFirst':
    'Bitte zuerst das Produkt speichern – danach lassen sich Bilder und das Sicherheitsdatenblatt hinzufügen.',
  'haendlerportal.images.title': 'Produktbilder',
  'haendlerportal.images.hint': 'JPEG, PNG oder WebP · max. 5 MB · bis zu {n} Bilder',
  'haendlerportal.images.drop': 'Bilder hierher ziehen oder auswählen',
  'haendlerportal.images.choose': 'Bilder auswählen',
  'haendlerportal.images.uploading': 'Bilder werden hochgeladen…',
  'haendlerportal.images.uploaded': 'Bilder hinzugefügt.',
  'haendlerportal.images.delete': 'Bild entfernen',
  'haendlerportal.images.errorType': 'Nur JPEG-, PNG- oder WebP-Bilder sind erlaubt.',
  'haendlerportal.images.errorSize': 'Ein Bild ist zu groß (max. 5 MB).',
  'haendlerportal.images.max': 'Maximal {n} Bilder je Produkt.',
  'haendlerportal.sdb.badge': 'SDB',
  'haendlerportal.sdb.title': 'Sicherheitsdatenblatt (SDB)',
  'haendlerportal.sdb.present': 'hinterlegt',
  'haendlerportal.sdb.none': 'fehlt',
  'haendlerportal.sdb.legal':
    'Für Chemikalien und Gefahrstoffe ist ein Sicherheitsdatenblatt gesetzlich vorgeschrieben (REACH/CLP – Lieferantenpflicht).',
  'haendlerportal.sdb.softRequire':
    'Produkte ohne SDB lassen sich speichern, sollten aber erst nach dem Upload aktiv geschaltet werden.',
  'haendlerportal.sdb.upload': 'PDF hochladen',
  'haendlerportal.sdb.replace': 'SDB ersetzen',
  'haendlerportal.sdb.download': 'SDB ansehen',
  'haendlerportal.sdb.uploaded': 'Sicherheitsdatenblatt gespeichert.',
  'haendlerportal.sdb.errorType': 'Das Sicherheitsdatenblatt muss ein PDF sein.',
  'haendlerportal.sdb.errorSize': 'Die Datei ist zu groß (max. 10 MB).',
  'haendlerportal.upload.error': 'Upload fehlgeschlagen.',
  // PR9: neu freigegebene Katalog-Felder im Produktformular
  'haendlerportal.section.category': 'Einordnung',
  'haendlerportal.section.shipping': 'Versand & Bestand',
  'haendlerportal.section.details': 'Details',
  'haendlerportal.field.categoryLabel': 'Kategorie',
  'haendlerportal.field.categoryNone': '— keine Kategorie —',
  'haendlerportal.field.categoryMain': '{name} (Hauptgruppe)',
  'haendlerportal.field.categorySdbHint': 'Diese Kategorie erfordert ein Sicherheitsdatenblatt (SDB).',
  'haendlerportal.field.herkunftsland': 'Herkunftsland',
  'haendlerportal.field.herkunftslandNone': '— keine Angabe —',
  'haendlerportal.field.versandKosten': 'Versandkosten (EUR)',
  'haendlerportal.field.versandHinweis': 'Versandhinweis',
  'haendlerportal.field.lieferzeitTage': 'Lieferzeit (Tage)',
  'haendlerportal.field.bestand': 'Lagerbestand',
  'haendlerportal.field.bestandHint': 'Leer lassen = unbegrenzt/unbekannt',
  'haendlerportal.field.anwendungshinweise': 'Anwendungshinweise',
  'haendlerportal.field.inhaltMenge': 'Inhalt/Gebinde (z. B. „500 ml“)',
  'haendlerportal.tech.title': 'Technische Daten',
  'haendlerportal.tech.hint': 'Als Merkmal und Wert, z. B. „Schichtdicke“ → „150 µm“.',
  'haendlerportal.tech.key': 'Merkmal',
  'haendlerportal.tech.value': 'Wert',
  'haendlerportal.tech.add': '+ Merkmal hinzufügen',
  'haendlerportal.tech.remove': 'Entfernen',
  // ---- Geräte-Gebrauchtmarkt ----------------------------------------------
  'nav.item.geraetemarkt': 'Gebrauchtmarkt',
  'geraetemarkt.title': 'Gebrauchtmarkt',
  'geraetemarkt.subtitle': 'Von Betrieb zu Betrieb: gebrauchte Geräte kaufen und anbieten, sich gegenseitig aushelfen – Aufträge weitergeben, freie Kapazität und Restmaterial anbieten.',
  'geraetemarkt.myListings': 'Meine Inserate',
  'geraetemarkt.newListing': 'Inserat einstellen',
  'geraetemarkt.resultCount': '{count} Inserate',
  'geraetemarkt.resetFilter': 'Filter zurücksetzen',
  'geraetemarkt.badge.verified': 'Gewerblich · verifizierter Betrieb',
  'geraetemarkt.badge.verifiedLong': 'Der Anbieter ist ein verifizierter Gewerbebetrieb.',
  'geraetemarkt.error.load': 'Der Gebrauchtmarkt konnte nicht geladen werden.',
  'geraetemarkt.empty.none': 'Noch keine Inserate vorhanden. Schauen Sie später wieder vorbei.',
  'geraetemarkt.empty.filtered': 'Keine Inserate für diese Filter gefunden.',
  'geraetemarkt.filter.allCategories': 'Alle Kategorien',
  'geraetemarkt.filter.condition': 'Zustand',
  'geraetemarkt.filter.any': 'Alle',
  'geraetemarkt.filter.region': 'Region',
  'geraetemarkt.filter.regionPlaceholder': 'PLZ',
  'geraetemarkt.filter.regionAria': 'Region nach 2-stelliger Postleitzahl filtern',
  'geraetemarkt.filter.art': 'Richtung',
  'geraetemarkt.filter.artAll': 'Alle',
  'geraetemarkt.filter.hilfeGroup': 'Nachbarschaftshilfe',
  'geraetemarkt.filter.umkreis': 'Umkreis',
  'geraetemarkt.filter.umkreisHint': 'Ungefährer Umkreis auf Regionsebene – kein exakter Kilometerradius. Eine Postleitzahl-Region ist selbst rund 50–100 km groß.',
  'geraetemarkt.umkreis.ueberall': 'Überall',
  'geraetemarkt.umkreis.nurRegion': 'Nur meine Region',
  'geraetemarkt.umkreis.km50': 'ca. 50 km',
  'geraetemarkt.umkreis.km100': 'ca. 100 km',
  'geraetemarkt.umkreis.km200': 'ca. 200 km',
  'geraetemarkt.art.angebot': 'Angebot',
  'geraetemarkt.art.gesuch': 'Gesuch',
  'geraetemarkt.sort.label': 'Sortierung',
  'geraetemarkt.sort.neu': 'Neueste zuerst',
  'geraetemarkt.sort.preis_auf': 'Preis aufsteigend',
  'geraetemarkt.sort.preis_ab': 'Preis absteigend',
  'geraetemarkt.kategorie.poliermaschine': 'Poliermaschine',
  'geraetemarkt.kategorie.sauger_extraktor': 'Sauger & Extraktor',
  'geraetemarkt.kategorie.plotter': 'Schneideplotter',
  'geraetemarkt.kategorie.ir_kurzwellen_trockner': 'IR-/Kurzwellen-Trockner',
  'geraetemarkt.kategorie.hebebuehne': 'Hebebühne',
  'geraetemarkt.kategorie.folier_werkzeug': 'Folier-Werkzeug',
  'geraetemarkt.kategorie.druckluft_kompressor': 'Druckluft & Kompressor',
  'geraetemarkt.kategorie.dampfreiniger': 'Dampfreiniger',
  'geraetemarkt.kategorie.messtechnik': 'Messtechnik',
  'geraetemarkt.kategorie.sonstiges_geraet': 'Sonstiges Gerät',
  'geraetemarkt.kategorie.auftragshilfe': 'Auftragshilfe / Sub-Auftrag',
  'geraetemarkt.kategorie.freie_kapazitaet': 'Freie Kapazität / Dienstleistung',
  'geraetemarkt.kategorie.restmaterial': 'Restmaterial (Folie u. Ä.)',
  'geraetemarkt.zustand.neu': 'Neu',
  'geraetemarkt.zustand.gebraucht': 'Gebraucht',
  'geraetemarkt.zustand.defekt': 'Defekt',
  'geraetemarkt.status.aktiv': 'Aktiv',
  'geraetemarkt.status.reserviert': 'Reserviert',
  'geraetemarkt.status.verkauft': 'Verkauft',
  'geraetemarkt.status.entfernt': 'Entfernt',
  'geraetemarkt.preisModus.fest': 'Festpreis',
  'geraetemarkt.preisModus.vb': 'Verhandlungsbasis',
  'geraetemarkt.preisModus.anfrage': 'Preis auf Anfrage',
  'geraetemarkt.preisModus.vbShort': 'VB',
  'geraetemarkt.detail.backToBrowse': 'Zurück zum Gebrauchtmarkt',
  'geraetemarkt.detail.notFoundTitle': 'Inserat nicht gefunden',
  'geraetemarkt.detail.notFound': 'Dieses Inserat ist nicht (mehr) verfügbar.',
  'geraetemarkt.detail.region': 'Region',
  'geraetemarkt.detail.listedOn': 'Eingestellt am',
  'geraetemarkt.detail.contactTitle': 'Verkäufer kontaktieren',
  'geraetemarkt.detail.contactTitleGesuch': 'Betrieb kontaktieren',
  'geraetemarkt.detail.descriptionTitle': 'Beschreibung',
  'geraetemarkt.detail.showContact': 'Kontakt anzeigen',
  'geraetemarkt.detail.contactLoading': 'Kontakt wird geladen…',
  'geraetemarkt.detail.contactError': 'Der Kontakt konnte nicht geladen werden.',
  'geraetemarkt.detail.revealHint': 'Der Kontakt des Betriebs wird angezeigt; die Offenlegung wird protokolliert.',
  'geraetemarkt.detail.email': 'E-Mail',
  'geraetemarkt.detail.phone': 'Telefon',
  'geraetemarkt.detail.address': 'Anschrift',
  'geraetemarkt.detail.noContactData': 'Für diesen Betrieb sind keine Kontaktdaten hinterlegt.',
  'geraetemarkt.detail.offAppHint': 'Die Abwicklung läuft direkt zwischen den Betrieben. Detailly vermittelt nur den Kontakt und wickelt keine Zahlung ab.',
  'geraetemarkt.meine.subtitle': 'Ihre eingestellten Geräte verwalten.',
  'geraetemarkt.meine.toBrowse': 'Zum Gebrauchtmarkt',
  'geraetemarkt.meine.empty': 'Sie haben noch keine Inserate eingestellt.',
  'geraetemarkt.meine.statusUpdated': 'Status aktualisiert.',
  'geraetemarkt.meine.statusError': 'Der Status konnte nicht geändert werden.',
  'geraetemarkt.meine.deleted': 'Inserat gelöscht.',
  'geraetemarkt.meine.deleteError': 'Das Inserat konnte nicht gelöscht werden.',
  'geraetemarkt.meine.deleteTitle': 'Inserat löschen',
  'geraetemarkt.meine.deleteConfirm': '„{titel}“ wirklich unwiderruflich löschen?',
  'geraetemarkt.meine.action.reserve': 'Reservieren',
  'geraetemarkt.meine.action.reactivate': 'Wieder aktivieren',
  'geraetemarkt.meine.action.markSold': 'Als verkauft markieren',
  'geraetemarkt.meine.action.republish': 'Erneut einstellen',
  'geraetemarkt.meine.action.edit': 'Bearbeiten',
  'geraetemarkt.meine.action.delete': 'Löschen',
  'geraetemarkt.form.roleHint': 'Inserate einstellen und verwalten darf nur die Betriebsleitung (Inhaber oder Manager).',
  'geraetemarkt.form.createTitle': 'Inserat einstellen',
  'geraetemarkt.form.editTitle': 'Inserat bearbeiten',
  'geraetemarkt.form.subtitle': 'Beschreiben Sie das Gerät möglichst genau – das schafft Vertrauen und spart Rückfragen.',
  'geraetemarkt.form.chemieTitle': 'KEINE Chemie oder Gefahrstoffe',
  'geraetemarkt.form.chemieHint': 'Poliermittel, Versiegelungen, Reiniger und andere Verbrauchs-/Gefahrstoffe sind hier nicht erlaubt. Geräte, Werkzeug, Aufträge, freie Kapazität und harmloses Restmaterial (z. B. Folie) sind willkommen.',
  'geraetemarkt.form.sectionBasics': 'Eckdaten',
  'geraetemarkt.form.titel': 'Titel',
  'geraetemarkt.form.titelPlaceholder': 'z. B. Rupes BigFoot LHR21 Poliermaschine',
  'geraetemarkt.form.art': 'Ich möchte …',
  'geraetemarkt.form.artHelp': 'Angebot = ich biete etwas an. Gesuch = ich suche Hilfe, Kapazität oder Material.',
  'geraetemarkt.form.groupGeraete': 'Geräte & Ausrüstung',
  'geraetemarkt.form.groupHilfe': 'Nachbarschaftshilfe',
  'geraetemarkt.form.kategorie': 'Kategorie',
  'geraetemarkt.form.zustand': 'Zustand',
  'geraetemarkt.form.beschreibung': 'Beschreibung',
  'geraetemarkt.form.beschreibungPlaceholder': 'Modell, Alter, Zubehör, Gebrauchsspuren, Grund des Verkaufs …',
  'geraetemarkt.form.beschreibungHelp': 'Je genauer, desto weniger Rückfragen. Bitte keine Kontaktdaten hier eintragen.',
  'geraetemarkt.form.sectionPrice': 'Preis',
  'geraetemarkt.form.preisModus': 'Preis-Art',
  'geraetemarkt.form.preis': 'Preis',
  'geraetemarkt.form.sectionLocation': 'Standort',
  'geraetemarkt.form.locationSubtitle': 'Nur grob – 2-stellige PLZ-Region und optional der Ort.',
  'geraetemarkt.form.plz': 'PLZ-Region',
  'geraetemarkt.form.plzHelp': 'Nur die ersten 2 Ziffern der Postleitzahl.',
  'geraetemarkt.form.ort': 'Ort (optional)',
  'geraetemarkt.form.ortPlaceholder': 'z. B. Raum München',
  'geraetemarkt.form.sectionImages': 'Bilder',
  'geraetemarkt.form.imagesSubtitle': 'Bis zu {max} Fotos (JPEG, PNG oder WebP).',
  'geraetemarkt.form.dropzone': 'Bilder hierher ziehen oder klicken zum Auswählen',
  'geraetemarkt.form.dropzoneHint': '{count} von {max} Bildern',
  'geraetemarkt.form.imagesFull': 'Maximal {max} Bilder erreicht',
  'geraetemarkt.form.removeImage': 'Bild entfernen',
  'geraetemarkt.form.confirm': 'Ich handle als Gewerbetreibender, meine Angaben sind korrekt und ich stelle keine Chemie/Gefahrstoffe ein.',
  'geraetemarkt.form.publish': 'Inserat veröffentlichen',
  'geraetemarkt.form.saveEdit': 'Änderungen speichern',
  'geraetemarkt.form.created': 'Inserat veröffentlicht.',
  'geraetemarkt.form.saved': 'Änderungen gespeichert.',
  'geraetemarkt.form.saveError': 'Das Inserat konnte nicht gespeichert werden.',
  'geraetemarkt.form.uploadError': 'Die Bilder konnten nicht hochgeladen werden.',
  'geraetemarkt.form.deleteImageError': 'Das Bild konnte nicht gelöscht werden.',
  'geraetemarkt.form.error.titelRequired': 'Bitte einen Titel angeben.',
  'geraetemarkt.form.error.titelMax': 'Der Titel darf höchstens 120 Zeichen haben.',
  'geraetemarkt.form.error.beschreibungRequired': 'Bitte eine Beschreibung angeben.',
  'geraetemarkt.form.error.beschreibungMax': 'Die Beschreibung darf höchstens 4000 Zeichen haben.',
  'geraetemarkt.form.error.preisRequired': 'Bitte einen Preis angeben.',
  'geraetemarkt.form.error.preisRange': 'Bitte einen gültigen Preis angeben.',
  'geraetemarkt.form.error.plz': 'Bitte genau 2 Ziffern angeben.',
  'geraetemarkt.form.error.ortMax': 'Der Ort darf höchstens 120 Zeichen haben.',
  'geraetemarkt.form.error.confirm': 'Bitte bestätigen Sie die Angaben, um fortzufahren.',
  'geraetemarkt.form.error.imageType': 'Nur JPEG-, PNG- oder WebP-Bilder sind erlaubt.',
  'geraetemarkt.form.error.imageMax': 'Maximal {max} Bilder je Inserat.',

  // ---- Kassenbuch (GoBD, Barzahlungen) -------------------------------------
  'kassenbuch.title': 'Kassenbuch',
  'kassenbuch.subtitle': 'Bargeld-Ein- und -Auszahlungen GoBD-konform erfassen, festschreiben und exportieren.',
  'kassenbuch.stat.balance': 'Kassenbestand',
  'kassenbuch.stat.balanceHint': 'Bargeld in der Kasse',
  'kassenbuch.stat.dayIn': 'Einnahmen heute',
  'kassenbuch.stat.dayOut': 'Ausgaben heute',
  'kassenbuch.stat.monthSaldo': 'Saldo Monat',
  'kassenbuch.add': 'Eintrag hinzufügen',
  'kassenbuch.addTitle': 'Kassenbuch-Eintrag',
  'kassenbuch.editTitle': 'Eintrag bearbeiten',
  'kassenbuch.type.einnahme': 'Einnahme',
  'kassenbuch.type.ausgabe': 'Ausgabe',
  'kassenbuch.filter.from': 'Von',
  'kassenbuch.filter.to': 'Bis',
  'kassenbuch.filter.type': 'Art',
  'kassenbuch.filter.all': 'Alle',
  'kassenbuch.filter.reset': 'Filter zurücksetzen',
  'kassenbuch.col.number': 'Nr.',
  'kassenbuch.col.date': 'Datum',
  'kassenbuch.col.type': 'Art',
  'kassenbuch.col.purpose': 'Zweck',
  'kassenbuch.col.amount': 'Betrag',
  'kassenbuch.col.balance': 'Bestand',
  'kassenbuch.col.status': 'Status',
  'kassenbuch.col.actions': 'Aktionen',
  'kassenbuch.status.draft': 'Entwurf',
  'kassenbuch.status.locked': 'Festgeschrieben',
  'kassenbuch.badge.storno': 'Storno zu Nr. {nr}',
  'kassenbuch.form.type': 'Art',
  'kassenbuch.form.amount': 'Betrag (€)',
  'kassenbuch.form.purpose': 'Zweck / Betreff',
  'kassenbuch.form.vat': 'MwSt-Satz',
  'kassenbuch.form.receiptNo': 'Belegnummer',
  'kassenbuch.form.category': 'Kategorie',
  'kassenbuch.form.date': 'Buchungsdatum',
  'kassenbuch.form.optional': 'optional',
  'kassenbuch.form.save': 'Speichern',
  'kassenbuch.form.error.amount': 'Bitte einen Betrag größer als 0 angeben.',
  'kassenbuch.form.error.purpose': 'Bitte einen Zweck angeben.',
  'kassenbuch.action.edit': 'Bearbeiten',
  'kassenbuch.action.delete': 'Löschen',
  'kassenbuch.action.storno': 'Stornieren',
  'kassenbuch.action.lock': 'Festschreiben',
  'kassenbuch.lock.title': 'Bis hier festschreiben?',
  'kassenbuch.lock.message': 'Dieser und alle früheren noch offenen Einträge werden festgeschrieben und sind danach unveränderlich (Korrektur nur per Storno-Gegenbuchung).',
  'kassenbuch.lock.confirm': 'Festschreiben',
  'kassenbuch.lockAll': 'Tagesabschluss',
  'kassenbuch.lockAll.title': 'Alle Entwürfe festschreiben?',
  'kassenbuch.lockAll.message': 'Alle noch offenen Einträge werden festgeschrieben und sind danach unveränderlich (Korrektur nur per Storno).',
  'kassenbuch.lockAll.confirm': 'Alle festschreiben',
  'kassenbuch.lockAll.none': 'Es gibt keine offenen Entwürfe zum Festschreiben.',
  'kassenbuch.delete.title': 'Eintrag löschen?',
  'kassenbuch.delete.message': 'Dieser Entwurf wird dauerhaft gelöscht. Nur der zuletzt erfasste, noch nicht festgeschriebene Eintrag ist löschbar.',
  'kassenbuch.delete.confirm': 'Löschen',
  'kassenbuch.storno.title': 'Eintrag stornieren?',
  'kassenbuch.storno.message': 'Es wird eine Storno-Gegenbuchung mit umgekehrter Buchungsart erstellt. Der ursprüngliche Eintrag bleibt unverändert erhalten (GoBD).',
  'kassenbuch.storno.confirm': 'Stornieren',
  'kassenbuch.export': 'CSV-Export',
  'kassenbuch.exporting': 'Wird exportiert…',
  'kassenbuch.empty': 'Noch keine Kassenbuch-Einträge. Erfassen Sie die erste Bargeld-Bewegung.',
  'kassenbuch.page': 'Seite',
  'kassenbuch.toast.created': 'Eintrag erfasst.',
  'kassenbuch.toast.updated': 'Eintrag aktualisiert.',
  'kassenbuch.toast.deleted': 'Eintrag gelöscht.',
  'kassenbuch.toast.locked': 'Eintrag festgeschrieben.',
  'kassenbuch.toast.lockedAll': '{count} Einträge festgeschrieben.',
  'kassenbuch.toast.storno': 'Storno-Gegenbuchung erstellt.',
  ...
  'geraetemarkt.rules.link': 'Marktplatz-Regeln & Rechtshinweise',
  'geraetemarkt.melden.report': 'Melden',
  'geraetemarkt.melden.done': 'Gemeldet',
  'geraetemarkt.melden.title': 'Inserat melden',
  'geraetemarkt.melden.intro': 'Warum möchten Sie dieses Inserat melden? Ihre Meldung geht an das Detailly-Team.',
  'geraetemarkt.melden.reasonLabel': 'Grund',
  'geraetemarkt.melden.grund.chemie_verboten': 'Chemie/Verbrauchsstoff (nicht erlaubt)',
  'geraetemarkt.melden.grund.spam': 'Spam oder Werbung',
  'geraetemarkt.melden.grund.betrug': 'Betrugsverdacht',
  'geraetemarkt.melden.grund.unangemessen': 'Unangemessener Inhalt',
  'geraetemarkt.melden.grund.sonstiges': 'Sonstiges',
  'geraetemarkt.melden.commentLabel': 'Kommentar (optional)',
  'geraetemarkt.melden.commentPlaceholder': 'Kurze Beschreibung des Problems …',
  'geraetemarkt.melden.submit': 'Meldung senden',
  'geraetemarkt.melden.sending': 'Wird gesendet …',
  'geraetemarkt.melden.success': 'Danke – Ihre Meldung ist eingegangen.',
  'geraetemarkt.melden.already': 'Sie haben dieses Inserat bereits gemeldet.',
  'geraetemarkt.melden.error': 'Die Meldung konnte nicht gesendet werden.',
  // ---- Betreiber-Moderation Gebrauchtmarkt (Plattform-Rollen) -------------
  'plattformGeraetemarkt.title': 'Gebrauchtmarkt-Moderation',
  'plattformGeraetemarkt.subtitle': 'Gemeldete und auffällige Inserate prüfen, verbergen oder entfernen.',
  'plattformGeraetemarkt.noAccess': 'Dieser Bereich ist dem Detailly-Plattform-Team vorbehalten.',
  'plattformGeraetemarkt.readonlyHint': 'Sie haben Lesezugriff. Moderations-Aktionen sind dem Plattform-Admin und -Support vorbehalten.',
  'plattformGeraetemarkt.error.load': 'Die Moderations-Daten konnten nicht geladen werden.',
  'plattformGeraetemarkt.actionError': 'Die Aktion konnte nicht ausgeführt werden.',
  'plattformGeraetemarkt.tab.meldungen': 'Meldungen',
  'plattformGeraetemarkt.tab.inserate': 'Inserate',
  'plattformGeraetemarkt.meldStatus.offen': 'Offen',
  'plattformGeraetemarkt.meldStatus.erledigt': 'Erledigt',
  'plattformGeraetemarkt.meldStatus.verworfen': 'Verworfen',
  'plattformGeraetemarkt.modStatus.ok': 'Sichtbar',
  'plattformGeraetemarkt.modStatus.verborgen': 'Verborgen',
  'plattformGeraetemarkt.modStatus.entfernt': 'Entfernt',
  'plattformGeraetemarkt.meldungen.filterLabel': 'Status',
  'plattformGeraetemarkt.meldungen.empty': 'Keine Meldungen in dieser Ansicht.',
  'plattformGeraetemarkt.meldungen.systemLabel': 'Automatische Vorprüfung',
  'plattformGeraetemarkt.meldungen.reportedAt': 'Gemeldet am {datum}',
  'plattformGeraetemarkt.meldungen.comment': 'Kommentar',
  'plattformGeraetemarkt.meldungen.inseratGone': 'Das betroffene Inserat ist nicht mehr vorhanden.',
  'plattformGeraetemarkt.meldungen.dismiss': 'Verwerfen',
  'plattformGeraetemarkt.meldungen.markDone': 'Erledigt',
  'plattformGeraetemarkt.inserate.filterLabel': 'Moderation',
  'plattformGeraetemarkt.inserate.filterAll': 'Alle',
  'plattformGeraetemarkt.inserate.empty': 'Keine Inserate in dieser Ansicht.',
  'plattformGeraetemarkt.action.hide': 'Verbergen',
  'plattformGeraetemarkt.action.remove': 'Entfernen',
  'plattformGeraetemarkt.action.restore': 'Wieder freigeben',
  'plattformGeraetemarkt.action.viewInserat': 'Inserat öffnen',
  'plattformGeraetemarkt.confirm.hideTitle': 'Inserat verbergen',
  'plattformGeraetemarkt.confirm.hideText': '„{titel}" wird für andere Betriebe ausgeblendet. Fortfahren?',
  'plattformGeraetemarkt.confirm.removeTitle': 'Inserat entfernen',
  'plattformGeraetemarkt.confirm.removeText': '„{titel}" wird dauerhaft aus dem Gebrauchtmarkt entfernt. Fortfahren?',
  'plattformGeraetemarkt.toast.moderated': 'Moderations-Status aktualisiert.',
  'plattformGeraetemarkt.toast.meldungDone': 'Meldung als erledigt markiert.',
  'plattformGeraetemarkt.toast.meldungDismissed': 'Meldung verworfen.',
  'plattformGeraetemarkt.table.listing': 'Inserat',
  'plattformGeraetemarkt.table.category': 'Kategorie',
  'plattformGeraetemarkt.table.status': 'Status',
  'plattformGeraetemarkt.table.moderation': 'Moderation',
  'plattformGeraetemarkt.table.createdAt': 'Eingestellt',

  // ---- Empfehlungs-/Affiliate-Programm (Weiterempfehlen) -------------------
  'common.optional': 'optional',
  'nav.item.affiliate': 'Weiterempfehlen',
  'cockpit.tab.empfehlungen': 'Empfehlungen',
  'cockpit.referrals.title': 'Empfehlungen',
  'cockpit.referrals.subtitle': 'Wer hat wen geworben – inklusive Gutschrift-Anwartschaften (nur Ansicht).',
  'cockpit.referrals.empty': 'Noch keine Empfehlungen erfasst.',
  'cockpit.referrals.col.referrer': 'Werber',
  'cockpit.referrals.col.referred': 'Geworbener Betrieb',
  'cockpit.referrals.col.status': 'Status',
  'cockpit.referrals.col.reward': 'Gutschrift',
  'cockpit.referrals.col.date': 'Geworben am',
  // ---- Marktrecherche-Register (Cockpit, Betreiber-intern) ---------------
  'cockpit.tab.marktregister': 'Marktregister',
  'marktregister.title': 'Marktrecherche-Register',
  'marktregister.subtitle':
    'Interne, neutrale Wettbewerbsbeobachtung: sachliche, öffentlich beobachtbare Fakten und die daraus abgeleitete eigene „besser machen“-Idee. Nur für das Detailly-Team.',
  'marktregister.new': 'Neue Beobachtung',
  'marktregister.empty': 'Noch keine Beobachtungen erfasst.',
  'marktregister.error.load': 'Beobachtungen konnten nicht geladen werden.',
  'marktregister.error.save': 'Aktion konnte nicht gespeichert werden.',
  'marktregister.action.edit': 'Bearbeiten',
  'marktregister.filter.status': 'Nach Status filtern',
  'marktregister.filter.kategorie': 'Nach Kategorie filtern',
  'marktregister.filter.prioritaet': 'Nach Priorität filtern',
  'marktregister.filter.allStatus': 'Alle Status',
  'marktregister.filter.allKategorie': 'Alle Kategorien',
  'marktregister.filter.allPrioritaet': 'Alle Prioritäten',
  'marktregister.card.observedOn': 'Beobachtet am',
  'marktregister.card.source': 'Quelle',
  'marktregister.field.wettbewerber': 'Wettbewerber',
  'marktregister.field.kategorie': 'Kategorie',
  'marktregister.field.beobachtung': 'Beobachtung',
  'marktregister.field.beobachtung.help': 'Nur sachliche, öffentlich beobachtbare Fakten – keine Wertung.',
  'marktregister.field.abgeleiteteIdee': 'Abgeleitete Idee',
  'marktregister.field.abgeleiteteIdee.help': 'Was machen wir daraus besser? Eigene To-do-Idee.',
  'marktregister.field.quelleUrl': 'Quelle (URL)',
  'marktregister.field.quelleUrl.help': 'Optional, nur http/https.',
  'marktregister.field.beobachtetAm': 'Beobachtet am',
  'marktregister.field.status': 'Status',
  'marktregister.field.prioritaet': 'Priorität',
  'marktregister.prioritaet.label': 'Priorität',
  'marktregister.kategorie.preis': 'Preis',
  'marktregister.kategorie.feature': 'Funktion',
  'marktregister.kategorie.ux': 'Bedienung',
  'marktregister.kategorie.marketing': 'Marketing',
  'marktregister.kategorie.sonstiges': 'Sonstiges',
  'marktregister.status.neu': 'Neu',
  'marktregister.status.geprueft': 'Geprüft',
  'marktregister.status.eingeplant': 'Eingeplant',
  'marktregister.status.umgesetzt': 'Umgesetzt',
  'marktregister.status.verworfen': 'Verworfen',
  'marktregister.prioritaet.hoch': 'Hoch',
  'marktregister.prioritaet.mittel': 'Mittel',
  'marktregister.prioritaet.niedrig': 'Niedrig',
  'marktregister.form.newTitle': 'Neue Beobachtung',
  'marktregister.form.editTitle': 'Beobachtung bearbeiten',
  'marktregister.form.neutralHint':
    'Neutral bleiben: nur sachliche, öffentlich beobachtbare Fakten festhalten und die eigene Verbesserungsidee ableiten. Keine Bewertung des Wettbewerbers.',
  'marktregister.form.saving': 'Speichert…',
  'marktregister.toast.created': 'Beobachtung angelegt.',
  'marktregister.toast.saved': 'Änderungen gespeichert.',
  'marktregister.toast.statusChanged': 'Status aktualisiert.',
  'marktregister.toast.deleted': 'Beobachtung gelöscht.',
  'marktregister.delete.title': 'Beobachtung löschen?',
  'marktregister.delete.message': 'Diese interne Notiz wird endgültig entfernt.',
  'affiliate.title': 'Weiterempfehlen',
  'affiliate.subtitle': 'Empfehle Detailly weiter und sichere dir Gutschriften, sobald ein geworbener Betrieb zahlt.',
  'affiliate.error.load': 'Empfehlungsdaten konnten nicht geladen werden.',
  'affiliate.stat.referred': 'Geworbene Betriebe',
  'affiliate.stat.paying': 'Davon zahlend',
  'affiliate.stat.rewards': 'Gutschrift-Anwartschaften',
  'affiliate.stat.rewardsHint': 'Wird bei Rechnungsstellung verrechnet',
  'affiliate.share.title': 'Dein Empfehlungs-Code',
  'affiliate.share.subtitle': 'Teile Code oder Link – neue Betriebe werden dir automatisch zugeordnet.',
  'affiliate.share.codeLabel': 'Empfehlungs-Code',
  'affiliate.share.linkLabel': 'Einladungs-Link',
  'affiliate.share.help': 'Wer sich über diesen Link registriert, zählt als deine Empfehlung.',
  'affiliate.copy': 'Kopieren',
  'affiliate.copied': 'Kopiert',
  'affiliate.copyLink': 'Link kopieren',
  'affiliate.reward.notice':
    'Sobald ein geworbener Betrieb ein bezahltes Abo abschließt, erhältst du 1 Monat Basic gutgeschrieben. Die Gutschrift wird bei der nächsten Rechnungsstellung verrechnet (noch keine automatische Zahlung).',
  'affiliate.reward.monatBasic': '1 Monat Basic',
  'affiliate.list.title': 'Deine Empfehlungen',
  'affiliate.list.subtitle': 'Nur deine eigenen geworbenen Betriebe.',
  'affiliate.list.empty': 'Noch keine Empfehlungen – teile deinen Link, um zu starten.',
  'affiliate.list.col.business': 'Betrieb',
  'affiliate.list.col.status': 'Status',
  'affiliate.list.col.reward': 'Gutschrift',
  'affiliate.list.col.date': 'Geworben am',
  'affiliate.status.paying': 'Zahlend',
  'affiliate.status.registered': 'Registriert',
  'affiliate.register.label': 'Empfehlungs-Code',
  'affiliate.register.placeholder': 'z. B. ABCD2345',
  'affiliate.register.help': 'Hast du einen Empfehlungs-Code erhalten? Trage ihn hier ein.',

  // ---- Schaufenster / Referenzen (Vorher/Nachher) --------------------------
  'schaufenster.title': 'Schaufenster',
  'schaufenster.subtitle': 'Zeige deine besten Vorher/Nachher-Ergebnisse öffentlich – mit Einverständnis des Kunden.',
  'schaufenster.upgrade': 'Das Schaufenster ist ab dem Basic-Tarif enthalten. Ein Upgrade schaltet es frei.',
  'schaufenster.empty': 'Noch keine Referenzen. Lege deine erste Vorher/Nachher-Referenz an.',
  'schaufenster.new': 'Neue Referenz',
  'schaufenster.count': '{n} Referenzen · {p} veröffentlicht',
  'schaufenster.publicLink.title': 'Öffentlicher Schaufenster-Link',
  'schaufenster.publicLink.hint': 'Teile diesen Link auf deiner Website oder in sozialen Netzwerken. Es sind nur veröffentlichte Referenzen sichtbar.',
  'schaufenster.form.newTitle': 'Neue Referenz anlegen',
  'schaufenster.form.editTitle': 'Referenz bearbeiten',
  'schaufenster.form.titel': 'Titel',
  'schaufenster.form.titelPlaceholder': 'z. B. Mercedes S-Klasse – Vollfolierung',
  'schaufenster.form.beschreibung': 'Beschreibung',
  'schaufenster.form.beschreibungPlaceholder': 'Kurz, was gemacht wurde (optional)',
  'schaufenster.form.gewerk': 'Gewerk',
  'schaufenster.form.vorher': 'Vorher-Bild',
  'schaufenster.form.nachher': 'Nachher-Bild',
  'schaufenster.form.bildWaehlen': 'Bild wählen',
  'schaufenster.form.bildErsetzen': 'Bild ersetzen',
  'schaufenster.form.bildHint': 'PNG, JPG oder WebP, bis 8 MB. Empfehlung: Kennzeichen und Personen unkenntlich machen.',
  'schaufenster.form.save': 'Speichern',
  'schaufenster.form.saving': 'Speichern …',
  'schaufenster.gewerk.folie': 'Folierung',
  'schaufenster.gewerk.aufbereitung': 'Aufbereitung',
  'schaufenster.gewerk.ppf': 'PPF (Lackschutz)',
  'schaufenster.status.published': 'Veröffentlicht',
  'schaufenster.status.draft': 'Entwurf',
  'schaufenster.action.publish': 'Veröffentlichen',
  'schaufenster.action.unpublish': 'Zurückziehen',
  'schaufenster.action.edit': 'Bearbeiten',
  'schaufenster.action.delete': 'Löschen',
  'schaufenster.action.copyLink': 'Link kopieren',
  'schaufenster.action.copied': 'Kopiert',
  'schaufenster.action.openPublic': 'Öffentlich ansehen',
  'schaufenster.consent.title': 'Einverständnis des Kunden',
  'schaufenster.consent.checkbox': 'Ich bestätige, dass mir das schriftliche Einverständnis des Kunden zur Veröffentlichung dieser Bilder vorliegt.',
  'schaufenster.consent.recommendation': 'Empfehlung: Kennzeichen und erkennbare Personen möglichst unkenntlich machen.',
  'schaufenster.consent.required': 'Bitte bestätige zuerst das Einverständnis des Kunden.',
  'schaufenster.consent.confirmedAt': 'Einverständnis bestätigt am {datum}',
  'schaufenster.publishDialog.title': 'Referenz veröffentlichen',
  'schaufenster.publishDialog.text': 'Nach dem Veröffentlichen ist diese Referenz über deinen öffentlichen Schaufenster-Link sichtbar.',
  'schaufenster.delete.title': 'Referenz löschen',
  'schaufenster.delete.text': 'Diese Referenz und ihre Bilder werden dauerhaft gelöscht. Fortfahren?',
  'schaufenster.preview.before': 'Vorher',
  'schaufenster.preview.after': 'Nachher',
  'schaufenster.slider.aria': 'Vorher/Nachher-Vergleich',
  'schaufenster.slider.handle': 'Trenner ziehen – oder mit den Pfeiltasten bewegen',
  'schaufenster.toast.created': 'Referenz angelegt',
  'schaufenster.toast.updated': 'Referenz aktualisiert',
  'schaufenster.toast.published': 'Referenz veröffentlicht',
  'schaufenster.toast.unpublished': 'Referenz zurückgezogen',
  'schaufenster.toast.deleted': 'Referenz gelöscht',
  'schaufenster.toast.copied': 'Link kopiert',
  'schaufenster.error.load': 'Die Referenzen konnten nicht geladen werden.',
  'schaufenster.error.images': 'Bitte ein Vorher- und ein Nachher-Bild wählen.',
  // Öffentliche Schaufenster-Seite
  'schaufenster.public.headline': 'Unsere Ergebnisse',
  'schaufenster.public.subtitle': 'Vorher und Nachher – ziehe den Regler, um den Unterschied zu sehen.',
  'schaufenster.public.by': 'Referenzen von {betrieb}',
  'schaufenster.public.empty': 'Aktuell sind keine Referenzen veröffentlicht.',
