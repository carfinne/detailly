...
export class Migration1783456549418 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Verwaiste Spalte "businessHours" (Merge-Verlust): die Tenant-Entity kennt
        // das Feld nicht mehr; die Oeffnungszeiten leben inzwischen in
        // settings.kalender (resolveKalender). Additiv INLINE aus der Baseline
        // entfernt, damit DB-Schema und Entity wieder uebereinstimmen. IF EXISTS =
        // idempotent; das down() (DROP TABLE "tenants") deckt die Spalte ohnehin ab.
        await queryRunner.query(`ALTER TABLE "tenants" DROP COLUMN IF EXISTS "businessHours"`);
        ...
        // Rechnungskorrektur: partieller Unique-Index als GoBD-Doppelstorno-Sperre
        // (je Ursprungsrechnung hoechstens EINE Stornorechnung) + Rueckverweis-Index.
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_invoices_stornoVonInvoiceId" ON "invoices" ("tenantId", "stornoVonInvoiceId") WHERE "stornoVonInvoiceId" IS NOT NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_invoices_storniertDurchInvoiceId" ON "invoices" ("storniertDurchInvoiceId") `);
